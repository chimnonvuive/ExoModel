...
//Communication
    //Dialog Mode
    constexpr int DM_PROGRESS_DLG                                       = 0;
    constexpr int DM_PROGRESS_AND_CONFIRM_DLG                           = 1;
    constexpr int DM_CONFIRM_DLG                                        = 2;
    constexpr int DM_NO_DLG                                             = 3;

//Configuration
    //MotorType
    constexpr WORD MT_DC_MOTOR                                          = 1;
    constexpr WORD MT_EC_SINUS_COMMUTATED_MOTOR                         = 10;
    constexpr WORD MT_EC_BLOCK_COMMUTATED_MOTOR                         = 11;

    //SensorType
    constexpr WORD ST_UNKNOWN                                           = 0;
    constexpr WORD ST_INC_ENCODER_3CHANNEL                              = 1;
    constexpr WORD ST_INC_ENCODER_2CHANNEL                              = 2;
    constexpr WORD ST_HALL_SENSORS                                      = 3;
    constexpr WORD ST_SSI_ABS_ENCODER_BINARY                            = 4;
    constexpr WORD ST_SSI_ABS_ENCODER_GREY                              = 5;
    constexpr WORD ST_INC_ENCODER2_3CHANNEL                             = 6;
    constexpr WORD ST_INC_ENCODER2_2CHANNEL                             = 7;
    constexpr WORD ST_ANALOG_INC_ENCODER_3CHANNEL                       = 8;
    constexpr WORD ST_ANALOG_INC_ENCODER_2CHANNEL                       = 9;

//In- and outputs
    //Digital input configuration
    constexpr WORD DIC_NEGATIVE_LIMIT_SWITCH                            = 0;
    constexpr WORD DIC_POSITIVE_LIMIT_SWITCH                            = 1;
    constexpr WORD DIC_HOME_SWITCH                                      = 2;
    constexpr WORD DIC_POSITION_MARKER                                  = 3;
    constexpr WORD DIC_DRIVE_ENABLE                                     = 4;
    constexpr WORD DIC_QUICK_STOP                                       = 5;
    constexpr WORD DIC_GENERAL_PURPOSE_J                                = 6;
    constexpr WORD DIC_GENERAL_PURPOSE_I                                = 7;
    constexpr WORD DIC_GENERAL_PURPOSE_H                                = 8;
    constexpr WORD DIC_GENERAL_PURPOSE_G                                = 9;
    constexpr WORD DIC_GENERAL_PURPOSE_F                                = 10;
    constexpr WORD DIC_GENERAL_PURPOSE_E                                = 11;
    constexpr WORD DIC_GENERAL_PURPOSE_D                                = 12;
    constexpr WORD DIC_GENERAL_PURPOSE_C                                = 13;
    constexpr WORD DIC_GENERAL_PURPOSE_B                                = 14;
    constexpr WORD DIC_GENERAL_PURPOSE_A                                = 15;

    //Digital output configuration
    constexpr WORD DOC_READY_FAULT                                      = 0;
    constexpr WORD DOC_POSITION_COMPARE                                 = 1;
    constexpr WORD DOC_GENERAL_PURPOSE_H                                = 8;
    constexpr WORD DOC_GENERAL_PURPOSE_G                                = 9;
    constexpr WORD DOC_GENERAL_PURPOSE_F                                = 10;
    constexpr WORD DOC_GENERAL_PURPOSE_E                                = 11;
    constexpr WORD DOC_GENERAL_PURPOSE_D                                = 12;
    constexpr WORD DOC_GENERAL_PURPOSE_C                                = 13;
    constexpr WORD DOC_GENERAL_PURPOSE_B                                = 14;
    constexpr WORD DOC_GENERAL_PURPOSE_A                                = 15;

    //Analog input configuration
    constexpr WORD AIC_ANALOG_CURRENT_SETPOINT                          = 0;
    constexpr WORD AIC_ANALOG_VELOCITY_SETPOINT                         = 1;
    constexpr WORD AIC_ANALOG_POSITION_SETPOINT                         = 2;
    constexpr WORD AIC_GENERAL_PURPOSE_H                                = 8;
    constexpr WORD AIC_GENERAL_PURPOSE_G                                = 9;
    constexpr WORD AIC_GENERAL_PURPOSE_F                                = 10;
    constexpr WORD AIC_GENERAL_PURPOSE_E                                = 11;
    constexpr WORD AIC_GENERAL_PURPOSE_D                                = 12;
    constexpr WORD AIC_GENERAL_PURPOSE_C                                = 13;
    constexpr WORD AIC_GENERAL_PURPOSE_B                                = 14;
    constexpr WORD AIC_GENERAL_PURPOSE_A                                = 15;

    //Analog output configuration
    constexpr WORD AOC_GENERAL_PURPOSE_A                                = 0;
    constexpr WORD AOC_GENERAL_PURPOSE_B                                = 1;

//Units
    //VelocityDimension
    constexpr BYTE VD_RPM                                               = 0xA4;

    //VelocityNotation
    constexpr char VN_STANDARD                                          = 0;
    constexpr char VN_DECI                                              = -1;
    constexpr char VN_CENTI                                             = -2;
    constexpr char VN_MILLI                                             = -3;

//Operational mode
    constexpr __int8 OMD_PROFILE_POSITION_MODE                          = 1;
    constexpr __int8 OMD_PROFILE_VELOCITY_MODE                          = 3;
    constexpr __int8 OMD_HOMING_MODE                                    = 6;
    constexpr __int8 OMD_INTERPOLATED_POSITION_MODE                     = 7;
    constexpr __int8 OMD_POSITION_MODE                                  = -1;
    constexpr __int8 OMD_VELOCITY_MODE                                  = -2;
    constexpr __int8 OMD_CURRENT_MODE                                   = -3;
    constexpr __int8 OMD_MASTER_ENCODER_MODE                            = -5;
    constexpr __int8 OMD_STEP_DIRECTION_MODE                            = -6;

//States
    constexpr WORD ST_DISABLED                                          = 0;
    constexpr WORD ST_ENABLED                                           = 1;
    constexpr WORD ST_QUICKSTOP                                         = 2;
    constexpr WORD ST_FAULT                                             = 3;

    //Homing mode
        //Homing method
    constexpr __int8 HM_ACTUAL_POSITION = 35;
    constexpr __int8 HM_NEGATIVE_LIMIT_SWITCH = 17;
    constexpr __int8 HM_NEGATIVE_LIMIT_SWITCH_AND_INDEX = 1;
    constexpr __int8 HM_POSITIVE_LIMIT_SWITCH = 18;
    constexpr __int8 HM_POSITIVE_LIMIT_SWITCH_AND_INDEX = 2;
    constexpr __int8 HM_HOME_SWITCH_POSITIVE_SPEED = 23;
    constexpr __int8 HM_HOME_SWITCH_POSITIVE_SPEED_AND_INDEX = 7;
    constexpr __int8 HM_HOME_SWITCH_NEGATIVE_SPEED = 27;
    constexpr __int8 HM_HOME_SWITCH_NEGATIVE_SPEED_AND_INDEX = 11;
    constexpr __int8 HM_CURRENT_THRESHOLD_POSITIVE_SPEED = -3;
    constexpr __int8 HM_CURRENT_THRESHOLD_POSITIVE_SPEED_AND_INDEX = -1;
    constexpr __int8 HM_CURRENT_THRESHOLD_NEGATIVE_SPEED = -4;
    constexpr __int8 HM_CURRENT_THRESHOLD_NEGATIVE_SPEED_AND_INDEX = -2;
    constexpr __int8 HM_INDEX_POSITIVE_SPEED = 34;
    constexpr __int8 HM_INDEX_NEGATIVE_SPEED = 33;

    //Input Output PositionMarker
        //PositionMarkerEdgeType
    constexpr BYTE PET_BOTH_EDGES = 0;
    constexpr BYTE PET_RISING_EDGE = 1;
    constexpr BYTE PET_FALLING_EDGE = 2;

    //PositionMarkerMode
    constexpr BYTE PM_CONTINUOUS = 0;
    constexpr BYTE PM_SINGLE = 1;
    constexpr BYTE PM_MULTIPLE = 2;

    //Input Output PositionCompare
        //PositionCompareOperationalMode
    constexpr BYTE PCO_SINGLE_POSITION_MODE = 0;
    constexpr BYTE PCO_POSITION_SEQUENCE_MODE = 1;

    //PositionCompareIntervalMode
    constexpr BYTE PCI_NEGATIVE_DIR_TO_REFPOS = 0;
    constexpr BYTE PCI_POSITIVE_DIR_TO_REFPOS = 1;
    constexpr BYTE PCI_BOTH_DIR_TO_REFPOS = 2;

    //PositionCompareDirectionDependency
    constexpr BYTE PCD_MOTOR_DIRECTION_NEGATIVE = 0;
    constexpr BYTE PCD_MOTOR_DIRECTION_POSITIVE = 1;
    constexpr BYTE PCD_MOTOR_DIRECTION_BOTH = 2;

    //Data recorder
        //Trigger type
    constexpr WORD DR_MOVEMENT_START_TRIGGER = 1;    //bit 1
    constexpr WORD DR_ERROR_TRIGGER = 2;    //bit 2
    constexpr WORD DR_DIGITAL_INPUT_TRIGGER = 4;    //bit 3
    constexpr WORD DR_MOVEMENT_END_TRIGGER = 8;    //bit 4

//CanLayer Functions
    constexpr WORD NCS_START_REMOTE_NODE = 1;
    constexpr WORD NCS_STOP_REMOTE_NODE = 2;
    constexpr WORD NCS_ENTER_PRE_OPERATIONAL = 128;
    constexpr WORD NCS_RESET_NODE = 129;
    constexpr WORD NCS_RESET_COMMUNICATION = 130;

    // Controller Gains
        // EController
    constexpr WORD EC_PI_CURRENT_CONTROLLER = 1;
    constexpr WORD EC_PI_VELOCITY_CONTROLLER = 10;
    constexpr WORD EC_PI_VELOCITY_CONTROLLER_WITH_OBSERVER = 11;
    constexpr WORD EC_PID_POSITION_CONTROLLER = 20;
    constexpr WORD EC_DUAL_LOOP_POSITION_CONTROLLER = 21;

    // EGain (EC_PI_CURRENT_CONTROLLER)
    constexpr WORD EG_PICC_P_GAIN = 1;
    constexpr WORD EG_PICC_I_GAIN = 2;

    // EGain (EC_PI_VELOCITY_CONTROLLER)
    constexpr WORD EG_PIVC_P_GAIN = 1;
    constexpr WORD EG_PIVC_I_GAIN = 2;
    constexpr WORD EG_PIVC_FEED_FORWARD_VELOCITY_GAIN = 10;
    constexpr WORD EG_PIVC_FEED_FORWARD_ACCELERATION_GAIN = 11;

    // EGain (EC_PI_VELOCITY_CONTROLLER_WITH_OBSERVER)
    constexpr WORD EG_PIVCWO_P_GAIN = 1;
    constexpr WORD EG_PIVCWO_I_GAIN = 2;
    constexpr WORD EG_PIVCWO_FEED_FORWARD_VELOCITY_GAIN = 10;
    constexpr WORD EG_PIVCWO_FEED_FORWARD_ACCELERATION_GAIN = 11;
    constexpr WORD EG_PIVCWO_OBSERVER_THETA_GAIN = 20;
    constexpr WORD EG_PIVCWO_OBSERVER_OMEGA_GAIN = 21;
    constexpr WORD EG_PIVCWO_OBSERVER_TAU_GAIN = 22;

    // EGain (EC_PID_POSITION_CONTROLLER)
    constexpr WORD EG_PIDPC_P_GAIN = 1;
    constexpr WORD EG_PIDPC_I_GAIN = 2;
    constexpr WORD EG_PIDPC_D_GAIN = 3;
    constexpr WORD EG_PIDPC_FEED_FORWARD_VELOCITY_GAIN = 10;
    constexpr WORD EG_PIDPC_FEED_FORWARD_ACCELERATION_GAIN = 11;

    // EGain (EC_DUAL_LOOP_POSITION_CONTROLLER)
    constexpr WORD EG_DLPC_AUXILIARY_LOOP_P_GAIN = 1;
    constexpr WORD EG_DLPC_AUXILIARY_LOOP_I_GAIN = 2;
    constexpr WORD EG_DLPC_AUXILIARY_LOOP_FEED_FORWARD_VELOCITY_GAIN = 10;
    constexpr WORD EG_DLPC_AUXILIARY_LOOP_FEED_FORWARD_ACCELERATION_GAIN = 11;
    constexpr WORD EG_DLPC_AUXILIARY_LOOP_OBSERVER_THETA_GAIN = 20;
    constexpr WORD EG_DLPC_AUXILIARY_LOOP_OBSERVER_OMEGA_GAIN = 21;
    constexpr WORD EG_DLPC_AUXILIARY_LOOP_OBSERVER_TAU_GAIN = 22;
    constexpr WORD EG_DLPC_MAIN_LOOP_P_GAIN_LOW = 101;
    constexpr WORD EG_DLPC_MAIN_LOOP_P_GAIN_HIGH = 102;
    constexpr WORD EG_DLPC_MAIN_LOOP_GAIN_SCHEDULING_WEIGHT = 110;
    constexpr WORD EG_DLPC_MAIN_LOOP_FILTER_COEFFICIENT_A = 120;
    constexpr WORD EG_DLPC_MAIN_LOOP_FILTER_COEFFICIENT_B = 121;
    constexpr WORD EG_DLPC_MAIN_LOOP_FILTER_COEFFICIENT_C = 122;
    constexpr WORD EG_DLPC_MAIN_LOOP_FILTER_COEFFICIENT_D = 123;
    constexpr WORD EG_DLPC_MAIN_LOOP_FILTER_COEFFICIENT_E = 124;
