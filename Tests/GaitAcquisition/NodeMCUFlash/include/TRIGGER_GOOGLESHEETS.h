...
void Send_Data();
void Google_Sheets_Init(char array_2d[10][7], String sheets_gas_id, int param_size);

String url;

char column_name[3][7];
...
void Send_Data()
{
	...
	String url = "/macros/s/" + GAS_ID + "/exec?"+column_name[0]+"="+Sensor_Values[0];
	int i=1;
	while(i!=Count)
	{
