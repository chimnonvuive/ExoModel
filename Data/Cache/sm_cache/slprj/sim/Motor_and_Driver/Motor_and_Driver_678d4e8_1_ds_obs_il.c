...
_cg_const_1 [ 137 ] = { true , true , true , false , true , true , true ,
...
PmBoolVector out ; int32_T b ; boolean_T t0 [ 137 ] ; ( void ) t1 ; out = t2
-> mOBS_IL ; for ( b = 0 ; b < 137 ; b ++ ) { t0 [ b ] = _cg_const_1 [ b ] ;
} for ( b = 0 ; b < 137 ; b ++ ) { out . mX [ b ] = t0 [ b ] ; } ( void ) sys
; ( void ) t2 ; return 0 ; }
