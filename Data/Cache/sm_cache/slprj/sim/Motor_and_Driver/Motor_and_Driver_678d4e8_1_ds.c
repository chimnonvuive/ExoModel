...
outj , PmRealVector * outr ) ; static NeEquationData s_equation_data [ 14 ] =
...
"Motor_and_Driver/Load/Inertia" , 2U , 7U , TRUE , 1.0 , "1" , } , { "" , 0U
, 8 , NE_EQUATION_DOMAIN_TIME , "Motor_and_Driver/Motor/DC Motor" , 1U , 9U ,
TRUE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Motor_and_Driver/Motor/DC Motor" , 2U , 10U , FALSE , 1.0 , "1" , } , { "" ,
0U , 8 , NE_EQUATION_DOMAIN_TIME , "Motor_and_Driver/Motor/DC Motor" , 2U ,
...
, "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge1" , 9U ,
15U , TRUE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
 "Motor_and_Driver/Load/Digital incremental encoder/Ideal Rotational Motion Sensor"
, 1U , 24U , TRUE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Motor_and_Driver/Load/Harmonic Drive" , 1U , 25U , TRUE , 1.0 , "1" , } , {
"" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Motor_and_Driver/Load/Rotational Friction" , 1U , 26U , FALSE , 1.0 , "1" ,
} , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Motor_and_Driver/Motor/DC Motor" , 1U , 27U , TRUE , 1.0 , "1" , } , { "" ,
0U , 8 , NE_EQUATION_DOMAIN_TIME , "Motor_and_Driver/Motor/DC Motor" , 1U ,
28U , FALSE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Motor_and_Driver/Motor/DC Motor" , 1U , 29U , FALSE , 1.0 , "1" , } } ;
static NeCERData * s_cer_data = NULL ; static NeICRData s_icr_data [ 1 ] = {
{ "" , 0U , 0 , "Motor_and_Driver/Load/Harmonic Drive" , 1U , 0U , } } ;
static NeVariableData s_variable_data [ 14 ] = { {
"Driver.Current_controller.Drive_Plant.H_Bridge1.v_lag" , 0U , 0 ,
"Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge1" , 1.0 ,
"1" , 0.0 , TRUE , FALSE , 1U , 1U , NE_INIT_MODE_MANDATORY , "Lag variable"
...
, } , { "Load.Inertia.w" , 0U , 0 , "Motor_and_Driver/Load/Inertia" , 1.0 ,
"1" , 0.0 , TRUE , FALSE , 1U , 1U , NE_INIT_MODE_MANDATORY ,
"Rotational velocity" , } , { "Motor.DC_Motor.i_L" , 0U , 0 ,
"Motor_and_Driver/Motor/DC Motor" , 1.0 , "1" , 0.0 , TRUE , FALSE , 1U , 1U
, NE_INIT_MODE_MANDATORY , "Current" , } , { "Motor.DC_Motor.temperature" ,
0U , 0 , "Motor_and_Driver/Motor/DC Motor" , 1.0 , "1" , 0.0 , TRUE , FALSE ,
1U , 1U , NE_INIT_MODE_MANDATORY , "Temperature" , } , { "Motor.DC_Motor.w" ,
0U , 0 , "Motor_and_Driver/Motor/DC Motor" , 1.0 , "1" , 0.0 , TRUE , FALSE ,
...
, } , { "Motor.DC_Motor.v" , 0U , 0 , "Motor_and_Driver/Motor/DC Motor" , 1.0
...
"Motor_and_Driver/Load/Harmonic Drive" , 1.0 , "1" , 0.0 , FALSE , FALSE , 1U
, 1U , NE_INIT_MODE_NONE , "Rotational velocity" , } , { "Load.Inertia.t" ,
0U , 0 , "Motor_and_Driver/Load/Inertia" , 1.0 , "1" , 0.0 , FALSE , FALSE ,
1U , 1U , NE_INIT_MODE_NONE , "Torque" , } , { "Load.Rotational_Friction.t" ,
0U , 0 , "Motor_and_Driver/Load/Rotational Friction" , 1.0 , "1" , 0.0 ,
FALSE , FALSE , 1U , 1U , NE_INIT_MODE_NONE , "Torque" , } , {
"Motor.DC_Motor.power_dissipated" , 0U , 0 ,
"Motor_and_Driver/Motor/DC Motor" , 1.0 , "1" , 0.0 , FALSE , FALSE , 1U , 1U
, NE_INIT_MODE_NONE , "Power dissipated" , } } ; static NeVariableData *
s_discrete_data = NULL ; static NeObservableData s_observable_data [ 140 ] =
...
"Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge1" , 1U , 1U
, "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current (BRK -> REF)" , } , {
"Driver.Current_controller.Drive_Plant.H_Bridge1.iENA" ,
"Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge1" , 1U , 1U
, "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current (ENA -> REF)" , } , {
"Driver.Current_controller.Drive_Plant.H_Bridge1.iREV" ,
"Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge1" , 1U , 1U
, "A" , 1.0 , "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Current (REV -> REF)" , } , {
...
, TRUE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Lag variable" , } , {
...
"Motor_and_Driver/Driver/Current controller/Drive Plant/I to U" , 1U , 1U ,
...
"Motor_and_Driver/Driver/Current controller/Drive Plant" , 1U , 1U , "V" ,
...
"Motor_and_Driver/Driver" , 1U , 1U , "V" , 1.0 , "V" ,
NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , { "Driver.X3a1.v" ,
"Motor_and_Driver/Driver" , 1U , 1U , "V" , 1.0 , "V" ,
NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Load.Digital_incremental_encoder.Ideal_Rotational_Motion_Sensor.A" ,
 "Motor_and_Driver/Load/Digital incremental encoder/Ideal Rotational Motion Sensor"
, 1U , 1U , "rad" , 1.0 , "1" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE
...
,
 "Motor_and_Driver/Load/Digital incremental encoder/Ideal Rotational Motion Sensor"
, 1U , 1U , "rad" , 1.0 , "1" , NE_NOMINAL_SOURCE_DERIVED ,
...
} , { "Load.Harmonic_Drive.F.w" , "Motor_and_Driver/Load/Harmonic Drive" , 1U
, 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE
, FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity"
, } , { "Load.Harmonic_Drive.H.T" , "Motor_and_Driver/Load/Harmonic Drive" ,
...
, 1U , "K" , 1.0 , "K" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE
...
"Load.Harmonic_Drive.gear.tF" , "Motor_and_Driver/Load/Harmonic Drive" , 1U ,
1U , "N*m" , 1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
...
"Load.Inertia.I.w" , "Motor_and_Driver/Load/Inertia" , 1U , 1U , "rad/s" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"Load.Inertia.J.w" , "Motor_and_Driver/Load/Inertia" , 1U , 1U , "rad/s" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"Load.Inertia.t" , "Motor_and_Driver/Load/Inertia" , 1U , 1U , "N*m" , 1.0 ,
...
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"Load.M0.w" , "Motor_and_Driver/Load" , 1U , 1U , "rad/s" , 1.0 , "1/s" ,
NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"Load.M1.w" , "Motor_and_Driver/Load" , 1U , 1U , "rad/s" , 1.0 , "1/s" ,
NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"Load.Rotational_Friction.C.w" , "Motor_and_Driver/Load/Rotational Friction"
, 1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , TRUE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , { "Load.Rotational_Friction.R.w" ,
"Motor_and_Driver/Load/Rotational Friction" , 1U , 1U , "rad/s" , 1.0 , "1/s"
, NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
...
1U , 1U , "rad/s" , 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED ,
NE_INIT_MODE_NONE , FALSE , FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE ,
"Rotational velocity" , } , { "Load.Rotational_Friction.power_dissipated" ,
"Motor_and_Driver/Load/Rotational Friction" , 1U , 1U , "J/s" , 1.0e-6 ,
...
1U , 1U , "N*m" , 1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE ,
FALSE , FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE ,
"Ideal_Torque_Sensor_T" , } , { "Load.torque_sensor_virtual.x0.w" ,
"Motor_and_Driver/Load/torque sensor (virtual)" , 1U , 1U , "rad/s" , 1.0 ,
"1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
...
, } , { "Motor.DC_Motor.fn.v" , "Motor_and_Driver/Motor/DC Motor" , 1U , 1U ,
"V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE , FALSE
, NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Motor.DC_Motor.fp.v" , "Motor_and_Driver/Motor/DC Motor" , 1U , 1U , "V" ,
1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
...
FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Motor.DC_Motor.i" , "Motor_and_Driver/Motor/DC Motor" , 1U , 1U , "A" , 1.0
, "A" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Armature current" , } , {
"Motor.DC_Motor.i_L" , "Motor_and_Driver/Motor/DC Motor" , 1U , 1U , "A" ,
...
"Motor.DC_Motor.power_dissipated" , "Motor_and_Driver/Motor/DC Motor" , 1U ,
1U , "W" , 1.0 , "kW" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE ,
FALSE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Power dissipated" , } , {
"Motor.DC_Motor.t" , "Motor_and_Driver/Motor/DC Motor" , 1U , 1U , "N*m" ,
1.0 , "N*m" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Torque" , } , {
"Motor.DC_Motor.temperature" , "Motor_and_Driver/Motor/DC Motor" , 1U , 1U ,
"K" , 1.0 , "K" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_MANDATORY , FALSE
, TRUE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Temperature" , } , {
"Motor.DC_Motor.v" , "Motor_and_Driver/Motor/DC Motor" , 1U , 1U , "V" , 1.0
...
"Motor.DC_Motor.w" , "Motor_and_Driver/Motor/DC Motor" , 1U , 1U , "rpm" ,
1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_MANDATORY , FALSE ,
TRUE , NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Angular velocity" , } , {
...
NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
"Motor.M1.w" , "Motor_and_Driver/Motor" , 1U , 1U , "rad/s" , 1.0 , "1/s" ,
NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Rotational velocity" , } , {
...
, 1.0 , "1/s" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE
, NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Rotational velocity" , } , {
"Motor.Subsystem.Conn1.T" , "Motor_and_Driver/Motor/Subsystem" , 1U , 1U ,
"K" , 1.0 , "K" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , FALSE ,
FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Temperature" , } , {
"Motor.Subsystem.Temperature_Sensor.A.T" ,
"Motor_and_Driver/Motor/Subsystem/Temperature Sensor" , 1U , 1U , "K" , 1.0 ,
...
"Motor_and_Driver/Motor/Subsystem/Thermal Reference" , 1U , 1U , "K" , 1.0 ,
"K" , NE_NOMINAL_SOURCE_DERIVED , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , TRUE , TRUE , "Temperature" , } , { "Motor.X3a0.v" ,
"Motor_and_Driver/Motor" , 1U , 1U , "V" , 1.0 , "V" ,
NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , { "Motor.X3a1.v" ,
"Motor_and_Driver/Motor" , 1U , 1U , "V" , 1.0 , "V" ,
NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE , FALSE ,
NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
...
"Motor.voltage_sensor.x0.v" , "Motor_and_Driver/Motor/voltage sensor" , 1U ,
1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , FALSE ,
FALSE , NE_FREQTIME_TYPE_TIME , FALSE , TRUE , "Voltage" , } , {
"Motor.voltage_sensor.x1.v" , "Motor_and_Driver/Motor/voltage sensor" , 1U ,
1U , "V" , 1.0 , "V" , NE_NOMINAL_SOURCE_MODEL , NE_INIT_MODE_NONE , TRUE ,
...
s_initial_assert_range = NULL ; static NeRange s_equation_range [ 30 ] = { {
 "C:/Program Files/MATLAB/R2021b/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, 1U , 1U , 1U , 1U , NE_RANGE_TYPE_PROTECTED , } , {
 "C:/Program Files/MATLAB/R2021b/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, 1U , 1U , 1U , 1U , NE_RANGE_TYPE_PROTECTED , } , {
...
s_cer_range = NULL ; static NeRange s_icr_range [ 1 ] = { {
...
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mM_P . mNumCol = 14 ;
out -> mM_P . mNumRow = 14 ; out -> mM_P . mJc = ( int32_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( int32_T ) , 15 ) ; out -> mM_P . mIr = (
...
NeDsMethodOutput ) , 1 ) ; out -> mM . mN = 6 ; out -> mM . mX = ( real_T * )
...
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mVMM . mN = 6 ; out -> mVMM . mX = (
...
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mDXM_P . mNumCol = 14 ; out ->
mDXM_P . mNumRow = 6 ; out -> mDXM_P . mJc = ( int32_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( int32_T ) , 15 ) ; out -> mDXM_P . mIr = (
...
mDDM_P . mNumRow = 6 ; out -> mDDM_P . mJc = ( int32_T * ) allocator ->
...
mDUM_P . mNumRow = 6 ; out -> mDUM_P . mJc = ( int32_T * ) allocator ->
...
mDTM_P . mNumRow = 6 ; out -> mDTM_P . mJc = ( int32_T * ) allocator ->
...
mDPM_P . mNumRow = 6 ; out -> mDPM_P . mJc = ( int32_T * ) allocator ->
...
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mA_P . mNumCol = 14 ; out ->
mA_P . mNumRow = 14 ; out -> mA_P . mJc = ( int32_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( int32_T ) , 15 ) ; out -> mA_P . mIr = (
int32_T * ) allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 26 ) ;
return out ; } static NeDsMethodOutput * ds_output_a ( const NeDynamicSystem
* ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out
= ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mA . mN = 26 ; out -> mA . mX = ( real_T *
...
= 14 ; out -> mB_P . mJc = ( int32_T * ) allocator -> mCallocFcn ( allocator
...
mNumCol = 1 ; out -> mC_P . mNumRow = 14 ; out -> mC_P . mJc = ( int32_T * )
...
* ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out
= ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mF . mN = 14 ; out -> mF . mX = ( real_T *
) allocator -> mCallocFcn ( allocator , sizeof ( real_T ) , 14 ) ; return out
; } static NeDsMethodOutput * ds_output_vmf ( const NeDynamicSystem * ds ,
PmAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mVMF . mN = 14 ; out -> mVMF . mX = (
boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof ( boolean_T ) , 14
) ; return out ; } static NeDsMethodOutput * ds_output_vpf ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mVPF . mN = 14 ; out -> mVPF .
mX = ( boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof ( boolean_T
) , 14 ) ; return out ; } static NeDsMethodOutput * ds_output_vsf ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mVSF . mN = 14 ; out -> mVSF .
mX = ( boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof ( boolean_T
) , 14 ) ; return out ; } static NeDsMethodOutput * ds_output_slf ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mSLF . mN = 14 ; out -> mSLF .
mX = ( boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof ( boolean_T
) , 14 ) ; return out ; } static NeDsMethodOutput * ds_output_slf0 ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mSLF0 . mN = 14 ; out -> mSLF0 .
mX = ( boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof ( boolean_T
) , 14 ) ; return out ; } static NeDsMethodOutput * ds_output_dxf_p ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mDXF_P . mNumCol = 14 ; out ->
mDXF_P . mNumRow = 14 ; out -> mDXF_P . mJc = ( int32_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( int32_T ) , 15 ) ; out -> mDXF_P . mIr = (
int32_T * ) allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 10 ) ;
return out ; } static NeDsMethodOutput * ds_output_dxf ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mDXF . mN = 10 ; out -> mDXF .
mX = ( real_T * ) allocator -> mCallocFcn ( allocator , sizeof ( real_T ) ,
10 ) ; return out ; } static NeDsMethodOutput * ds_output_duf_p ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mDUF_P . mNumCol = 2 ; out ->
mDUF_P . mNumRow = 14 ; out -> mDUF_P . mJc = ( int32_T * ) allocator ->
...
mDTF_P . mNumRow = 14 ; out -> mDTF_P . mJc = ( int32_T * ) allocator ->
...
mDDF_P . mNumRow = 14 ; out -> mDDF_P . mJc = ( int32_T * ) allocator ->
...
mDPDXF_P . mNumRow = 10 ; out -> mDPDXF_P . mJc = ( int32_T * ) allocator ->
...
mDWF_P . mNumRow = 14 ; out -> mDWF_P . mJc = ( int32_T * ) allocator ->
...
mTDUF_P . mNumRow = 14 ; out -> mTDUF_P . mJc = ( int32_T * ) allocator ->
...
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mTDXF_P . mNumCol = 14 ; out ->
mTDXF_P . mNumRow = 14 ; out -> mTDXF_P . mJc = ( int32_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( int32_T ) , 15 ) ; out -> mTDXF_P . mIr = (
...
mDNF_P . mNumRow = 14 ; out -> mDNF_P . mJc = ( int32_T * ) allocator ->
...
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mDNF_V_X . mN = 14 ; out ->
mDNF_V_X . mX = ( boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof
( boolean_T ) , 14 ) ; return out ; } static NeDsMethodOutput * ds_output_cer
( const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
...
14 ; out -> mDXCER_P . mNumRow = 0 ; out -> mDXCER_P . mJc = ( int32_T * )
...
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mIC . mN = 14 ; out ->
mIC . mX = ( real_T * ) allocator -> mCallocFcn ( allocator , sizeof ( real_T
) , 14 ) ; return out ; } static NeDsMethodOutput * ds_output_icr ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mICR . mN = 1 ; out -> mICR . mX
= ( real_T * ) allocator -> mCallocFcn ( allocator , sizeof ( real_T ) , 1 )
; return out ; } static NeDsMethodOutput * ds_output_icr_im ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mICR_IM . mN = 1 ; out ->
mICR_IM . mX = ( int32_T * ) allocator -> mCallocFcn ( allocator , sizeof (
int32_T ) , 1 ) ; return out ; } static NeDsMethodOutput * ds_output_icr_id (
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mICR_ID . mN = 1 ; out
...
mICR_IL . mN = 1 ; out -> mICR_IL . mX = ( boolean_T * ) allocator ->
...
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mDXICR_P . mNumCol = 14 ; out ->
mDXICR_P . mNumRow = 1 ; out -> mDXICR_P . mJc = ( int32_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( int32_T ) , 15 ) ; out -> mDXICR_P . mIr =
( int32_T * ) allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 0 )
...
mDDICR_P . mNumRow = 1 ; out -> mDDICR_P . mJc = ( int32_T * ) allocator ->
...
mTDUICR_P . mNumRow = 1 ; out -> mTDUICR_P . mJc = ( int32_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( int32_T ) , 3 ) ; out -> mTDUICR_P . mIr =
( int32_T * ) allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 0 )
; return out ; } static NeDsMethodOutput * ds_output_icrm_p ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mICRM_P . mNumCol = 14 ; out ->
mICRM_P . mNumRow = 1 ; out -> mICRM_P . mJc = ( int32_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( int32_T ) , 15 ) ; out -> mICRM_P . mIr = (
int32_T * ) allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 0 ) ;
...
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mDXICRM_P . mNumCol = 14 ; out
-> mDXICRM_P . mNumRow = 0 ; out -> mDXICRM_P . mJc = ( int32_T * ) allocator
-> mCallocFcn ( allocator , sizeof ( int32_T ) , 15 ) ; out -> mDXICRM_P .
mIr = ( int32_T * ) allocator -> mCallocFcn ( allocator , sizeof ( int32_T )
...
; out -> mMDUY_P . mNumRow = 6 ; out -> mMDUY_P . mJc = ( int32_T * )
...
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mMDXY_P . mNumCol = 14
; out -> mMDXY_P . mNumRow = 6 ; out -> mMDXY_P . mJc = ( int32_T * )
allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 15 ) ; out ->
...
; out -> mTDUY_P . mNumRow = 6 ; out -> mTDUY_P . mJc = ( int32_T * )
allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 3 ) ; out ->
mTDUY_P . mIr = ( int32_T * ) allocator -> mCallocFcn ( allocator , sizeof (
int32_T ) , 0 ) ; return out ; } static NeDsMethodOutput * ds_output_tdxy_p (
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mTDXY_P . mNumCol = 14
; out -> mTDXY_P . mNumRow = 6 ; out -> mTDXY_P . mJc = ( int32_T * )
allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 15 ) ; out ->
mTDXY_P . mIr = ( int32_T * ) allocator -> mCallocFcn ( allocator , sizeof (
int32_T ) , 6 ) ; return out ; } static NeDsMethodOutput * ds_output_y (
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mY . mN = 6 ; out ->
mY . mX = ( real_T * ) allocator -> mCallocFcn ( allocator , sizeof ( real_T
) , 6 ) ; return out ; } static NeDsMethodOutput * ds_output_dxy_p ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mDXY_P . mNumCol = 14 ; out ->
mDXY_P . mNumRow = 6 ; out -> mDXY_P . mJc = ( int32_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( int32_T ) , 15 ) ; out -> mDXY_P . mIr = (
int32_T * ) allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 6 ) ;
...
mDUY_P . mNumRow = 6 ; out -> mDUY_P . mJc = ( int32_T * ) allocator ->
...
mDTY_P . mNumRow = 6 ; out -> mDTY_P . mJc = ( int32_T * ) allocator ->
...
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mLOG . mN = 83 ; out
-> mLOG . mX = ( real_T * ) allocator -> mCallocFcn ( allocator , sizeof (
real_T ) , 83 ) ; return out ; } static NeDsMethodOutput * ds_output_assert (
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mASSERT . mN = 12 ;
out -> mASSERT . mX = ( int32_T * ) allocator -> mCallocFcn ( allocator ,
sizeof ( int32_T ) , 12 ) ; return out ; } static NeDsMethodOutput *
ds_output_passert ( const NeDynamicSystem * ds , PmAllocator * allocator ) {
NeDsMethodOutput * out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator
-> mCallocFcn ( allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out ->
...
NeDsMethodOutput * out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator
-> mCallocFcn ( allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out ->
mDXDELT_P . mNumCol = 14 ; out -> mDXDELT_P . mNumRow = 0 ; out -> mDXDELT_P
. mJc = ( int32_T * ) allocator -> mCallocFcn ( allocator , sizeof ( int32_T
) , 15 ) ; out -> mDXDELT_P . mIr = ( int32_T * ) allocator -> mCallocFcn (
...
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mOBS_EXP . mN = 137 ;
out -> mOBS_EXP . mX = ( real_T * ) allocator -> mCallocFcn ( allocator ,
sizeof ( real_T ) , 137 ) ; return out ; } static NeDsMethodOutput *
ds_output_obs_act ( const NeDynamicSystem * ds , PmAllocator * allocator ) {
NeDsMethodOutput * out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator
-> mCallocFcn ( allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out ->
mOBS_ACT . mN = 137 ; out -> mOBS_ACT . mX = ( real_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( real_T ) , 137 ) ; return out ; } static
NeDsMethodOutput * ds_output_obs_all ( const NeDynamicSystem * ds ,
PmAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mOBS_ALL . mN = 137 ; out -> mOBS_ALL . mX
= ( real_T * ) allocator -> mCallocFcn ( allocator , sizeof ( real_T ) , 137
) ; return out ; } static NeDsMethodOutput * ds_output_obs_il ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mOBS_IL . mN = 137 ; out ->
mOBS_IL . mX = ( boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof (
boolean_T ) , 137 ) ; return out ; } static NeDsMethodOutput * ds_output_dp_l
( const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
...
PmAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mQX_P . mNumCol = 14 ; out -> mQX_P .
mNumRow = 14 ; out -> mQX_P . mJc = ( int32_T * ) allocator -> mCallocFcn (
allocator , sizeof ( int32_T ) , 15 ) ; out -> mQX_P . mIr = ( int32_T * )
allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 0 ) ; return out ;
} static NeDsMethodOutput * ds_output_qu_p ( const NeDynamicSystem * ds ,
PmAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mQU_P . mNumCol = 2 ; out -> mQU_P .
mNumRow = 14 ; out -> mQU_P . mJc = ( int32_T * ) allocator -> mCallocFcn (
...
mNumRow = 14 ; out -> mQT_P . mJc = ( int32_T * ) allocator -> mCallocFcn (
...
mNumRow = 14 ; out -> mQ1_P . mJc = ( int32_T * ) allocator -> mCallocFcn (
allocator , sizeof ( int32_T ) , 2 ) ; out -> mQ1_P . mIr = ( int32_T * )
allocator -> mCallocFcn ( allocator , sizeof ( int32_T ) , 0 ) ; return out ;
} static NeDsMethodOutput * ds_output_var_tol ( const NeDynamicSystem * ds ,
PmAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mVAR_TOL . mN = 14 ; out -> mVAR_TOL . mX =
( real_T * ) allocator -> mCallocFcn ( allocator , sizeof ( real_T ) , 14 ) ;
return out ; } static NeDsMethodOutput * ds_output_eq_tol ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mEQ_TOL . mN = 14 ; out ->
mEQ_TOL . mX = ( real_T * ) allocator -> mCallocFcn ( allocator , sizeof (
real_T ) , 14 ) ; return out ; } static NeDsMethodOutput * ds_output_lv (
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mLV . mN = 14 ; out ->
mLV . mX = ( boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof (
boolean_T ) , 14 ) ; return out ; } static NeDsMethodOutput * ds_output_slv (
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mSLV . mN = 14 ; out
-> mSLV . mX = ( boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof (
boolean_T ) , 14 ) ; return out ; } static NeDsMethodOutput * ds_output_nldv
( const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mNLDV . mN = 14 ; out
-> mNLDV . mX = ( boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof
( boolean_T ) , 14 ) ; return out ; } static NeDsMethodOutput *
ds_output_sclv ( const NeDynamicSystem * ds , PmAllocator * allocator ) {
NeDsMethodOutput * out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator
-> mCallocFcn ( allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mSCLV
. mN = 14 ; out -> mSCLV . mX = ( boolean_T * ) allocator -> mCallocFcn (
allocator , sizeof ( boolean_T ) , 14 ) ; return out ; } static
NeDsMethodOutput * ds_output_imin ( const NeDynamicSystem * ds , PmAllocator
* allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mIMIN . mN = 14 ; out -> mIMIN . mX = (
real_T * ) allocator -> mCallocFcn ( allocator , sizeof ( real_T ) , 14 ) ;
return out ; } static NeDsMethodOutput * ds_output_imax ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mIMAX . mN = 14 ; out -> mIMAX .
mX = ( real_T * ) allocator -> mCallocFcn ( allocator , sizeof ( real_T ) ,
14 ) ; return out ; } static NeDsMethodOutput * ds_output_dimin ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
...
) { NeDynamicSystem * ds ; _NeDynamicSystem * _ds ; static NeDsIoInfo
input_info [ 2 ] ; static NeDsIoInfo output_info [ 6 ] ; _ds = (
_NeDynamicSystem * ) allocator -> mCallocFcn ( allocator , sizeof (
_NeDynamicSystem ) , 1 ) ; _ds -> mAlloc = * allocator ; _ds -> mRefCnt = 1 ;
ds = & _ds -> mBase ; ds -> mNumVariables = 14 ; ds ->
mNumDiscreteRealVariables = 0 ; ds -> mNumDifferentialVariables = 6 ; ds ->
mNumEquations = 14 ; ds -> mNumCEResiduals = 0 ; ds -> mNumICResiduals = 1 ;
ds -> mNumModes = 3 ; ds -> mNumMajorModes = 0 ; ds -> mNumRealCache = 0 ; ds
-> mNumIntCache = 0 ; ds -> mNumObservables = 140 ; ds ->
mNumObservableElements = 137 ; ds -> mNumZcs = 3 ; ds -> mNumAsserts = 12 ;
ds -> mNumAssertRanges = 12 ; ds -> mNumParamAsserts = 0 ; ds ->
mNumParamAssertRanges = 0 ; ds -> mNumInitialAsserts = 0 ; ds ->
mNumInitialAssertRanges = 0 ; ds -> mNumRanges = 3 ; ds -> mNumEquationRanges
= 30 ; ds -> mNumCERRanges = 0 ; ds -> mNumICRRanges = 1 ; ds ->
...
mIsScalable = FALSE ; ds -> mNumIo [ NE_INPUT_IO_TYPE ] = 2 ; input_info [ 0
] . mIdentifier =
"Driver.Current_controller.Drive_Plant.I_to_U.Simulink_PS_Converter_output" ;
...
mName =
"Driver.Current_controller.Drive_Plant.I_to_U.Simulink_PS_Converter1_output"
; input_info [ 1 ] . mUnit = "V" ; ds -> mIo [ NE_INPUT_IO_TYPE ] =
input_info ; ds -> mNumIo [ NE_OUTPUT_IO_TYPE ] = 6 ; output_info [ 0 ] .
mIdentifier =
"Driver.Current_controller.Drive_Plant.Subsystem.Current_Sensor_I" ;
output_info [ 0 ] . mM = 1 ; output_info [ 0 ] . mN = 1 ; output_info [ 0 ] .
mName = "Driver.Current_controller.Drive_Plant.Subsystem.Current_Sensor_I" ;
output_info [ 0 ] . mUnit = "A" ; output_info [ 1 ] . mIdentifier =
"Load.Digital_incremental_encoder.Ideal_Rotational_Motion_Sensor_A" ;
output_info [ 1 ] . mM = 1 ; output_info [ 1 ] . mN = 1 ; output_info [ 1 ] .
mName = "Load.Digital_incremental_encoder.Ideal_Rotational_Motion_Sensor_A" ;
output_info [ 1 ] . mUnit = "rad" ; output_info [ 2 ] . mIdentifier =
"Load.Digital_incremental_encoder.Ideal_Rotational_Motion_Sensor_W" ;
output_info [ 2 ] . mM = 1 ; output_info [ 2 ] . mN = 1 ; output_info [ 2 ] .
mName = "Load.Digital_incremental_encoder.Ideal_Rotational_Motion_Sensor_W" ;
output_info [ 2 ] . mUnit = "rad/s" ; output_info [ 3 ] . mIdentifier =
"Load.torque_sensor_virtual.Ideal_Torque_Sensor_T" ; output_info [ 3 ] . mM =
1 ; output_info [ 3 ] . mN = 1 ; output_info [ 3 ] . mName =
"Load.torque_sensor_virtual.Ideal_Torque_Sensor_T" ; output_info [ 3 ] .
mUnit = "N*m" ; output_info [ 4 ] . mIdentifier =
"Motor.Subsystem.Temperature_Sensor_T" ; output_info [ 4 ] . mM = 1 ;
output_info [ 4 ] . mN = 1 ; output_info [ 4 ] . mName =
"Motor.Subsystem.Temperature_Sensor_T" ; output_info [ 4 ] . mUnit = "K" ;
output_info [ 5 ] . mIdentifier = "Motor.voltage_sensor.Voltage_Sensor_V" ;
output_info [ 5 ] . mM = 1 ; output_info [ 5 ] . mN = 1 ; output_info [ 5 ] .
mName = "Motor.voltage_sensor.Voltage_Sensor_V" ; output_info [ 5 ] . mUnit =
"V" ; ds -> mIo [ NE_OUTPUT_IO_TYPE ] = output_info ; ds -> mReleaseReference
...
Motor_and_Driver_678d4e8_1_ds_a_p ; ds -> mMakeOutput [ NE_DS_METHOD_A_P ] =
ds_output_a_p ; ds -> mMethods [ NE_DS_METHOD_A ] =
Motor_and_Driver_678d4e8_1_ds_a ; ds -> mMakeOutput [ NE_DS_METHOD_A ] =
...
NE_DS_METHOD_F ] = Motor_and_Driver_678d4e8_1_ds_f ; ds -> mMakeOutput [
...
Motor_and_Driver_678d4e8_1_ds_dxf ; ds -> mMakeOutput [ NE_DS_METHOD_DXF ] =
...
NE_DS_METHOD_TDXF_P ] = Motor_and_Driver_678d4e8_1_ds_tdxf_p ; ds ->
...
ds_zc ; ds -> mMakeOutput [ NE_DS_METHOD_ZC ] = ds_output_zc ; ds -> mMethods
...
NE_DS_METHOD_LOG ] = Motor_and_Driver_678d4e8_1_ds_log ; ds -> mMakeOutput [
...
Motor_and_Driver_678d4e8_1_ds_obs_exp ; ds -> mMakeOutput [
NE_DS_METHOD_OBS_EXP ] = ds_output_obs_exp ; ds -> mMethods [
NE_DS_METHOD_OBS_ACT ] = Motor_and_Driver_678d4e8_1_ds_obs_act ; ds ->
mMakeOutput [ NE_DS_METHOD_OBS_ACT ] = ds_output_obs_act ; ds -> mMethods [
NE_DS_METHOD_OBS_ALL ] = Motor_and_Driver_678d4e8_1_ds_obs_all ; ds ->
mMakeOutput [ NE_DS_METHOD_OBS_ALL ] = ds_output_obs_all ; ds -> mMethods [
NE_DS_METHOD_OBS_IL ] = Motor_and_Driver_678d4e8_1_ds_obs_il ; ds ->
...
; out . mX [ 11 ] = 1 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static
...
( void ) t1 ; out = t2 -> mDXCER_P ; out . mNumCol = 14ULL ; out . mNumRow =
...
mDXDELT_P ; out . mNumCol = 14ULL ; out . mNumRow = 0ULL ; out . mJc [ 0 ] =
...
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mDUDELT_P ; out . mNumCol = 2ULL ; out . mNumRow =
...
mNumCol = 14ULL ; out . mNumRow = 14ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1
] = 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 1 ; out . mJc [ 4 ] = 1 ; out
. mJc [ 5 ] = 4 ; out . mJc [ 6 ] = 4 ; out . mJc [ 7 ] = 5 ; out . mJc [ 8 ]
= 9 ; out . mJc [ 9 ] = 10 ; out . mJc [ 10 ] = 10 ; out . mJc [ 11 ] = 10 ;
out . mJc [ 12 ] = 10 ; out . mJc [ 13 ] = 10 ; out . mJc [ 14 ] = 10 ; out .
mIr [ 0 ] = 10 ; out . mIr [ 1 ] = 4 ; out . mIr [ 2 ] = 12 ; out . mIr [ 3 ]
= 13 ; out . mIr [ 4 ] = 7 ; out . mIr [ 5 ] = 4 ; out . mIr [ 6 ] = 7 ; out
. mIr [ 7 ] = 12 ; out . mIr [ 8 ] = 13 ; out . mIr [ 9 ] = 7 ; ( void ) sys
; ( void ) t2 ; return 0 ; } static int32_T ds_duf ( const NeDynamicSystem *
sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) {
PmRealVector out ; real_T U_idx_0 ; U_idx_0 = t1 -> mU . mX [ 0 ] ; out = t2
-> mDUF ; if ( U_idx_0 <= 0.0 ) { U_idx_0 = 0.0 ; } else if ( U_idx_0 >= 18.0
) { U_idx_0 = 0.0 ; } else { U_idx_0 = 0.055555555555555552 ; } out . mX [ 0
] = - U_idx_0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T
ds_duf_p ( const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mDUF_P ; out . mNumCol = 2ULL ; out . mNumRow = 14ULL ; out . mJc [ 0 ] = 0 ;
out . mJc [ 1 ] = 1 ; out . mJc [ 2 ] = 1 ; out . mIr [ 0 ] = 6 ; ( void )
sys ; ( void ) t2 ; return 0 ; } static int32_T ds_dtf ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { ( void ) t1 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T
ds_dtf_p ( const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mDTF_P ; out . mNumCol = 1ULL ; out . mNumRow = 14ULL ; out . mJc [ 0 ] = 0 ;
out . mJc [ 1 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static
...
14ULL ; out . mJc [ 0 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; }
...
= 2ULL ; out . mNumRow = 14ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ;
...
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mC_P ; out . mNumCol = 1ULL ; out . mNumRow = 14ULL
; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; ( void ) sys ; ( void ) t2 ;
return 0 ; } static int32_T ds_tduf_p ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mTDUF_P ; out . mNumCol = 2ULL ; out . mNumRow =
14ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 1 ; out . mJc [ 2 ] = 2 ; out
. mIr [ 0 ] = 6 ; out . mIr [ 1 ] = 7 ; ( void ) sys ; ( void ) t2 ; return 0
...
mNumCol = 0ULL ; out . mNumRow = 14ULL ; out . mJc [ 0 ] = 0 ; ( void ) sys ;
...
out . mX [ 4 ] = true ; out . mX [ 5 ] = false ; out . mX [ 6 ] = true ; out
. mX [ 7 ] = true ; out . mX [ 8 ] = false ; out . mX [ 9 ] = false ; out .
mX [ 10 ] = true ; out . mX [ 11 ] = false ; out . mX [ 12 ] = true ; out .
mX [ 13 ] = true ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T
...
out . mX [ 12 ] = false ; out . mX [ 13 ] = false ; ( void ) sys ; ( void )
t2 ; return 0 ; } static int32_T ds_dnf ( const NeDynamicSystem * sys , const
...
out ; ( void ) t1 ; out = t2 -> mDNF_P ; out . mNumCol = 6ULL ; out . mNumRow
= 14ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 1 ;
out . mJc [ 3 ] = 1 ; out . mJc [ 4 ] = 1 ; out . mJc [ 5 ] = 1 ; out . mJc [
6 ] = 1 ; out . mIr [ 0 ] = 6 ; ( void ) sys ; ( void ) t2 ; return 0 ; }
...
; out . mX [ 5 ] = true ; out . mX [ 6 ] = false ; out . mX [ 7 ] = true ;
out . mX [ 8 ] = false ; out . mX [ 9 ] = false ; out . mX [ 10 ] = true ;
out . mX [ 11 ] = false ; out . mX [ 12 ] = true ; out . mX [ 13 ] = true ; (
...
false ; out . mX [ 13 ] = false ; ( void ) sys ; ( void ) t2 ; return 0 ; }
static int32_T ds_vpf ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmBoolVector out ; (
void ) t1 ; out = t2 -> mVPF ; out . mX [ 0 ] = false ; out . mX [ 1 ] =
...
out . mX [ 9 ] = false ; out . mX [ 10 ] = false ; out . mX [ 11 ] = false ;
out . mX [ 12 ] = false ; out . mX [ 13 ] = false ; ( void ) sys ; ( void )
t2 ; return 0 ; } static int32_T ds_ic ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmRealVector out ; (
void ) t1 ; out = t2 -> mIC ; out . mX [ 0 ] = 1.0 ; out . mX [ 1 ] = 0.0 ;
out . mX [ 2 ] = 0.0 ; out . mX [ 3 ] = 0.0 ; out . mX [ 4 ] = 298.15 ; out .
mX [ 5 ] = 0.0 ; out . mX [ 6 ] = 0.0 ; out . mX [ 7 ] = 1.0 ; out . mX [ 8 ]
= 0.0 ; out . mX [ 9 ] = 0.0 ; out . mX [ 10 ] = 0.0 ; out . mX [ 11 ] = 0.0
; out . mX [ 12 ] = 0.0 ; out . mX [ 13 ] = 0.0 ; ( void ) sys ; ( void ) t2
; return 0 ; } static int32_T ds_icr ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmRealVector out ; (
void ) t1 ; out = t2 -> mICR ; out . mX [ 0 ] = 0.0 ; ( void ) sys ; ( void )
t2 ; return 0 ; } static int32_T ds_icr_im ( const NeDynamicSystem * sys ,
const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmIntVector out ;
( void ) t1 ; out = t2 -> mICR_IM ; out . mX [ 0 ] = 3 ; ( void ) sys ; (
void ) t2 ; return 0 ; } static int32_T ds_icr_id ( const NeDynamicSystem *
sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) {
PmBoolVector out ; ( void ) t1 ; out = t2 -> mICR_ID ; out . mX [ 0 ] = false
; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_icr_il ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { PmBoolVector out ; ( void ) t1 ; out = t2 -> mICR_IL ; out . mX [ 0 ]
= true ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_dxicr (
const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { ( void ) t1 ; ( void ) sys ; ( void ) t2 ; return 0
; } static int32_T ds_dxicr_p ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mDXICR_P ; out . mNumCol = 14ULL ; out . mNumRow =
...
mNumCol = 0ULL ; out . mNumRow = 1ULL ; out . mJc [ 0 ] = 0 ; ( void ) sys ;
...
2ULL ; out . mNumRow = 1ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; out
. mJc [ 2 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T
ds_icrm ( const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { ( void ) t1 ; ( void ) sys ; ( void ) t2 ; return 0
; } static int32_T ds_icrm_p ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mICRM_P ; out . mNumCol = 14ULL ; out . mNumRow =
1ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ; out
. mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 0 ; out . mJc [ 5 ] = 0 ; out . mJc [ 6 ]
= 0 ; out . mJc [ 7 ] = 0 ; out . mJc [ 8 ] = 0 ; out . mJc [ 9 ] = 0 ; out .
mJc [ 10 ] = 0 ; out . mJc [ 11 ] = 0 ; out . mJc [ 12 ] = 0 ; out . mJc [ 13
...
t1 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_ddicrm_p (
const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
...
pmf_get_inf ( ) ; out . mX [ 13 ] = - pmf_get_inf ( ) ; ( void ) sys ; ( void
...
. mX [ 1 ] = 1.0 ; out . mX [ 2 ] = - 0.1 ; out . mX [ 3 ] = - 0.000109 ; out
. mX [ 4 ] = 0.1 ; out . mX [ 5 ] = 0.00050599999999999994 ; ( void ) sys ; (
...
14ULL ; out . mNumRow = 14ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 1 ;
...
0 ; out . mIr [ 1 ] = 1 ; out . mIr [ 2 ] = 2 ; out . mIr [ 3 ] = 4 ; out .
mIr [ 4 ] = 3 ; out . mIr [ 5 ] = 5 ; ( void ) sys ; ( void ) t2 ; return 0 ;
} static int32_T ds_dxm ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { ( void ) t1 ; ( void )
sys ; ( void ) t2 ; return 0 ; } static int32_T ds_dxm_p ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 -> mDXM_P ; out .
mNumCol = 14ULL ; out . mNumRow = 6ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1
] = 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 0 ; out
. mJc [ 5 ] = 0 ; out . mJc [ 6 ] = 0 ; out . mJc [ 7 ] = 0 ; out . mJc [ 8 ]
= 0 ; out . mJc [ 9 ] = 0 ; out . mJc [ 10 ] = 0 ; out . mJc [ 11 ] = 0 ; out
. mJc [ 12 ] = 0 ; out . mJc [ 13 ] = 0 ; out . mJc [ 14 ] = 0 ; ( void ) sys
; ( void ) t2 ; return 0 ; } static int32_T ds_ddm ( const NeDynamicSystem *
sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { ( void ) t1
; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_ddm_p ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
...
mNumCol = 2ULL ; out . mNumRow = 6ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ]
...
6ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; ( void ) sys ; ( void ) t2
...
sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) {
PmBoolVector out ; ( void ) t1 ; out = t2 -> mVMM ; out . mX [ 0 ] = false ;
out . mX [ 1 ] = false ; out . mX [ 2 ] = false ; out . mX [ 3 ] = false ;
out . mX [ 4 ] = false ; out . mX [ 5 ] = false ; ( void ) sys ; ( void ) t2
; return 0 ; } static int32_T ds_mode ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmIntVector out ;
real_T U_idx_1 ; real_T X_idx_6 ; U_idx_1 = t1 -> mU . mX [ 1 ] ; X_idx_6 =
t1 -> mX . mX [ 6 ] ; out = t2 -> mMODE ; out . mX [ 0 ] = ( int32_T ) (
X_idx_6 < 0.0 ) ; out . mX [ 1 ] = ( int32_T ) ( X_idx_6 <= 18.0 ) ; out . mX
[ 2 ] = ( int32_T ) ( U_idx_1 > 2.5 ) ; ( void ) sys ; ( void ) t2 ; return 0
...
= 0 ; out . mJc [ 9 ] = 0 ; out . mJc [ 10 ] = 0 ; out . mJc [ 11 ] = 0 ; out
. mJc [ 12 ] = 0 ; out . mJc [ 13 ] = 0 ; out . mJc [ 14 ] = 0 ; ( void ) sys
; ( void ) t2 ; return 0 ; } static int32_T ds_qu_p ( const NeDynamicSystem *
sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) {
PmSparsityPattern out ; ( void ) t1 ; out = t2 -> mQU_P ; out . mNumCol =
2ULL ; out . mNumRow = 14ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ;
out . mJc [ 2 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static
...
-> mQT_P ; out . mNumCol = 1ULL ; out . mNumRow = 14ULL ; out . mJc [ 0 ] = 0
; out . mJc [ 1 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static
int32_T ds_q1_p ( const NeDynamicSystem * sys , const NeDynamicSystemInput *
t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2
-> mQ1_P ; out . mNumCol = 1ULL ; out . mNumRow = 14ULL ; out . mJc [ 0 ] = 0
; out . mJc [ 1 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static
...
] = 1.0E-9 ; out . mX [ 12 ] = 1.0E-9 ; out . mX [ 13 ] = 1.0E-9 ; ( void )
...
12 ] = 1.0E-9 ; out . mX [ 13 ] = 1.0E-9 ; ( void ) sys ; ( void ) t2 ;
...
out . mX [ 8 ] = false ; out . mX [ 9 ] = true ; out . mX [ 10 ] = true ; out
. mX [ 11 ] = true ; out . mX [ 12 ] = false ; out . mX [ 13 ] = false ; (
...
real_T X_idx_1 ; real_T X_idx_12 ; real_T X_idx_4 ; real_T X_idx_7 ; real_T
X_idx_8 ; real_T X_idx_9 ; X_idx_1 = t3 -> mX . mX [ 1 ] ; X_idx_4 = t3 -> mX
. mX [ 4 ] ; X_idx_7 = t3 -> mX . mX [ 7 ] ; X_idx_8 = t3 -> mX . mX [ 8 ] ;
X_idx_9 = t3 -> mX . mX [ 9 ] ; X_idx_12 = t3 -> mX . mX [ 12 ] ; out = t4 ->
mY ; out . mX [ 0 ] = - X_idx_7 ; out . mX [ 1 ] = X_idx_1 ; out . mX [ 2 ] =
X_idx_9 ; out . mX [ 3 ] = X_idx_12 ; out . mX [ 4 ] = X_idx_4 ; out . mX [ 5
] = X_idx_8 ; ( void ) sys ; ( void ) t4 ; return 0 ; } static int32_T ds_dxy
( const NeDynamicSystem * sys , const NeDynamicSystemInput * t2 ,
NeDsMethodOutput * t3 ) { PmRealVector out ; ( void ) t2 ; out = t3 -> mDXY ;
out . mX [ 0 ] = 1.0 ; out . mX [ 1 ] = 1.0 ; out . mX [ 2 ] = - 1.0 ; out .
mX [ 3 ] = 1.0 ; out . mX [ 4 ] = 1.0 ; out . mX [ 5 ] = 1.0 ; ( void ) sys ;
( void ) t3 ; return 0 ; } static int32_T ds_dxy_p ( const NeDynamicSystem *
sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) {
PmSparsityPattern out ; ( void ) t1 ; out = t2 -> mDXY_P ; out . mNumCol =
14ULL ; out . mNumRow = 6ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ;
out . mJc [ 2 ] = 1 ; out . mJc [ 3 ] = 1 ; out . mJc [ 4 ] = 1 ; out . mJc [
5 ] = 2 ; out . mJc [ 6 ] = 2 ; out . mJc [ 7 ] = 2 ; out . mJc [ 8 ] = 3 ;
out . mJc [ 9 ] = 4 ; out . mJc [ 10 ] = 5 ; out . mJc [ 11 ] = 5 ; out . mJc
[ 12 ] = 5 ; out . mJc [ 13 ] = 6 ; out . mJc [ 14 ] = 6 ; out . mIr [ 0 ] =
1 ; out . mIr [ 1 ] = 4 ; out . mIr [ 2 ] = 0 ; out . mIr [ 3 ] = 5 ; out .
mIr [ 4 ] = 2 ; out . mIr [ 5 ] = 3 ; ( void ) sys ; ( void ) t2 ; return 0 ;
...
t2 -> mMDUY_P ; out . mNumCol = 2ULL ; out . mNumRow = 6ULL ; out . mJc [ 0 ]
= 0 ; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ; ( void ) sys ; ( void ) t2
; return 0 ; } static int32_T ds_mdxy_p ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mMDXY_P ; out . mNumCol = 14ULL ; out . mNumRow =
6ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ; out
. mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 0 ; out . mJc [ 5 ] = 0 ; out . mJc [ 6 ]
= 0 ; out . mJc [ 7 ] = 0 ; out . mJc [ 8 ] = 0 ; out . mJc [ 9 ] = 0 ; out .
mJc [ 10 ] = 0 ; out . mJc [ 11 ] = 0 ; out . mJc [ 12 ] = 0 ; out . mJc [ 13
] = 0 ; out . mJc [ 14 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; }
...
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mTDUY_P ; out . mNumCol = 2ULL ; out . mNumRow =
...
mNumCol = 14ULL ; out . mNumRow = 6ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1
] = 0 ; out . mJc [ 2 ] = 1 ; out . mJc [ 3 ] = 1 ; out . mJc [ 4 ] = 1 ; out
. mJc [ 5 ] = 2 ; out . mJc [ 6 ] = 2 ; out . mJc [ 7 ] = 2 ; out . mJc [ 8 ]
= 3 ; out . mJc [ 9 ] = 4 ; out . mJc [ 10 ] = 5 ; out . mJc [ 11 ] = 5 ; out
. mJc [ 12 ] = 5 ; out . mJc [ 13 ] = 6 ; out . mJc [ 14 ] = 6 ; out . mIr [
0 ] = 1 ; out . mIr [ 1 ] = 4 ; out . mIr [ 2 ] = 0 ; out . mIr [ 3 ] = 5 ;
out . mIr [ 4 ] = 2 ; out . mIr [ 5 ] = 3 ; ( void ) sys ; ( void ) t2 ;
...
t4 ) { PmRealVector out ; real_T U_idx_1 ; real_T X_idx_6 ; real_T t1 ;
int32_T M_idx_0 ; M_idx_0 = t3 -> mM . mX [ 0 ] ; U_idx_1 = t3 -> mU . mX [ 1
] ; X_idx_6 = t3 -> mX . mX [ 6 ] ; out = t4 -> mZC ; if ( M_idx_0 == 0 ) {
U_idx_1 -= 2.5 ; } else { U_idx_1 = 0.0 ; } if ( M_idx_0 == 0 ) { t1 = 18.0 -
X_idx_6 ; } else { t1 = 0.0 ; } out . mX [ 0 ] = U_idx_1 ; out . mX [ 1 ] = -
X_idx_6 ; out . mX [ 2 ] = t1 ; ( void ) sys ; ( void ) t4 ; return 0 ; }
