...
"Motor_and_Driver/Motor/DC Motor" , 1U , 7U , TRUE , 1.0 , "1" , } , { "" ,
0U , 8 , NE_EQUATION_DOMAIN_TIME , "Motor_and_Driver/Motor/DC Motor" , 2U ,
8U , FALSE , 1.0 , "1" , } , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Motor_and_Driver/Motor/DC Motor" , 2U , 10U , TRUE , 1.0 , "1" , } , { "" ,
0U , 8 , NE_EQUATION_DOMAIN_TIME ,
...
"Motor_and_Driver/Load/Rotational Friction" , 1U , 22U , FALSE , 1.0 , "1" ,
} , { "" , 0U , 8 , NE_EQUATION_DOMAIN_TIME ,
"Motor_and_Driver/Motor/DC Motor" , 1U , 23U , FALSE , 1.0 , "1" , } , { "" ,
0U , 8 , NE_EQUATION_DOMAIN_TIME , "Motor_and_Driver/Motor/DC Motor" , 1U ,
24U , FALSE , 1.0 , "1" , } } ; static NeCERData * s_cer_data = NULL ; static
NeICRData s_icr_data [ 1 ] = { { "" , 0U , 0 ,
"Motor_and_Driver/Load/Harmonic Drive" , 1U , 0U , } } ; static
NeVariableData s_variable_data [ 10 ] = { {
...
, } , { "Motor.DC_Motor.w" , 0U , 0 , "Motor_and_Driver/Motor/DC Motor" , 1.0
, "1" , 0.0 , TRUE , FALSE , 1U , 1U , NE_INIT_MODE_MANDATORY ,
"Angular velocity" , } , {
"Load.Digital_incremental_encoder.Ideal_Rotational_Motion_Sensor.phi" , 0U ,
0 ,
 "Motor_and_Driver/Load/Digital incremental encoder/Ideal Rotational Motion Sensor"
, 1.0 , "1" , 0.0 , TRUE , FALSE , 1U , 1U , NE_INIT_MODE_MANDATORY , "Angle"
, } , { "Motor.DC_Motor.i_L" , 0U , 0 , "Motor_and_Driver/Motor/DC Motor" ,
1.0 , "1" , 0.0 , TRUE , FALSE , 1U , 1U , NE_INIT_MODE_MANDATORY , "Current"
, } , { "Motor.DC_Motor.temperature" , 0U , 0 ,
"Motor_and_Driver/Motor/DC Motor" , 1.0 , "1" , 0.0 , TRUE , FALSE , 1U , 1U
, NE_INIT_MODE_MANDATORY , "Temperature" , } , {
...
"Load.Rotational_Friction.t" , 0U , 0 ,
"Motor_and_Driver/Load/Rotational Friction" , 1.0 , "1" , 0.0 , FALSE , FALSE
, 1U , 1U , NE_INIT_MODE_NONE , "Torque" , } , {
...
s_discrete_data = NULL ; static NeObservableData s_observable_data [ 136 ] =
...
s_initial_assert_range = NULL ; static NeRange s_equation_range [ 25 ] = { {
 "C:/Program Files/MATLAB/R2021b/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, 1U , 1U , 1U , 1U , NE_RANGE_TYPE_PROTECTED , } , {
 "C:/Program Files/MATLAB/R2021b/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp"
, 1U , 1U , 1U , 1U , NE_RANGE_TYPE_PROTECTED , } , {
...
NeDsMethodOutput ) , 1 ) ; out -> mM . mN = 5 ; out -> mM . mX = ( real_T * )
...
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mVMM . mN = 5 ; out -> mVMM . mX = (
...
mDXM_P . mNumRow = 5 ; out -> mDXM_P . mJc = ( int32_T * ) allocator ->
...
mDDM_P . mNumRow = 5 ; out -> mDDM_P . mJc = ( int32_T * ) allocator ->
...
mDUM_P . mNumRow = 5 ; out -> mDUM_P . mJc = ( int32_T * ) allocator ->
...
mDTM_P . mNumRow = 5 ; out -> mDTM_P . mJc = ( int32_T * ) allocator ->
...
mDPM_P . mNumRow = 5 ; out -> mDPM_P . mJc = ( int32_T * ) allocator ->
...
* ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out
= ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mA . mN = 18 ; out -> mA . mX = ( real_T *
...
const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mOBS_EXP . mN = 133 ;
out -> mOBS_EXP . mX = ( real_T * ) allocator -> mCallocFcn ( allocator ,
sizeof ( real_T ) , 133 ) ; return out ; } static NeDsMethodOutput *
ds_output_obs_act ( const NeDynamicSystem * ds , PmAllocator * allocator ) {
NeDsMethodOutput * out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator
-> mCallocFcn ( allocator , sizeof ( NeDsMethodOutput ) , 1 ) ; out ->
mOBS_ACT . mN = 133 ; out -> mOBS_ACT . mX = ( real_T * ) allocator ->
mCallocFcn ( allocator , sizeof ( real_T ) , 133 ) ; return out ; } static
NeDsMethodOutput * ds_output_obs_all ( const NeDynamicSystem * ds ,
PmAllocator * allocator ) { NeDsMethodOutput * out ; ( void ) ds ; out = (
NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator , sizeof (
NeDsMethodOutput ) , 1 ) ; out -> mOBS_ALL . mN = 133 ; out -> mOBS_ALL . mX
= ( real_T * ) allocator -> mCallocFcn ( allocator , sizeof ( real_T ) , 133
) ; return out ; } static NeDsMethodOutput * ds_output_obs_il ( const
NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput * out ; (
void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn ( allocator
, sizeof ( NeDsMethodOutput ) , 1 ) ; out -> mOBS_IL . mN = 133 ; out ->
mOBS_IL . mX = ( boolean_T * ) allocator -> mCallocFcn ( allocator , sizeof (
boolean_T ) , 133 ) ; return out ; } static NeDsMethodOutput * ds_output_dp_l
( const NeDynamicSystem * ds , PmAllocator * allocator ) { NeDsMethodOutput *
out ; ( void ) ds ; out = ( NeDsMethodOutput * ) allocator -> mCallocFcn (
...
ds = & _ds -> mBase ; ds -> mNumVariables = 10 ; ds ->
mNumDiscreteRealVariables = 0 ; ds -> mNumDifferentialVariables = 5 ; ds ->
mNumEquations = 10 ; ds -> mNumCEResiduals = 0 ; ds -> mNumICResiduals = 1 ;
ds -> mNumModes = 3 ; ds -> mNumMajorModes = 0 ; ds -> mNumRealCache = 0 ; ds
-> mNumIntCache = 0 ; ds -> mNumObservables = 136 ; ds ->
mNumObservableElements = 133 ; ds -> mNumZcs = 3 ; ds -> mNumAsserts = 12 ;
...
= 25 ; ds -> mNumCERRanges = 0 ; ds -> mNumICRRanges = 1 ; ds ->
...
NE_DS_METHOD_A ] = Motor_and_Driver_678d4e8_1_ds_a ; ds -> mMakeOutput [
...
( void ) t1 ; out = t2 -> mDXCER_P ; out . mNumCol = 10ULL ; out . mNumRow =
...
; return 0 ; } static int32_T ds_dudelt ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { ( void ) t1 ; ( void )
...
mDXF_P ; out . mNumCol = 10ULL ; out . mNumRow = 10ULL ; out . mJc [ 0 ] = 0
; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 1 ; out . mJc [ 3 ] = 1 ; out . mJc
[ 4 ] = 1 ; out . mJc [ 5 ] = 4 ; out . mJc [ 6 ] = 5 ; out . mJc [ 7 ] = 9 ;
out . mJc [ 8 ] = 10 ; out . mJc [ 9 ] = 10 ; out . mJc [ 10 ] = 10 ; out .
mIr [ 0 ] = 7 ; out . mIr [ 1 ] = 3 ; out . mIr [ 2 ] = 8 ; out . mIr [ 3 ] =
9 ; out . mIr [ 4 ] = 6 ; out . mIr [ 5 ] = 3 ; out . mIr [ 6 ] = 6 ; out .
mIr [ 7 ] = 8 ; out . mIr [ 8 ] = 9 ; out . mIr [ 9 ] = 6 ; ( void ) sys ; (
void ) t2 ; return 0 ; } static int32_T ds_duf ( const NeDynamicSystem * sys
, const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmRealVector
out ; real_T U_idx_0 ; U_idx_0 = t1 -> mU . mX [ 0 ] ; out = t2 -> mDUF ; if
( U_idx_0 <= 0.0 ) { U_idx_0 = 0.0 ; } else if ( U_idx_0 >= 18.0 ) { U_idx_0
= 0.0 ; } else { U_idx_0 = 0.055555555555555552 ; } out . mX [ 0 ] = -
U_idx_0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_duf_p (
const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mDUF_P ; out . mNumCol = 2ULL ; out . mNumRow = 10ULL ; out . mJc [ 0 ] = 0 ;
out . mJc [ 1 ] = 1 ; out . mJc [ 2 ] = 1 ; out . mIr [ 0 ] = 5 ; ( void )
sys ; ( void ) t2 ; return 0 ; } static int32_T ds_dtf ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { ( void ) t1 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T
ds_dtf_p ( const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mDTF_P ; out . mNumCol = 1ULL ; out . mNumRow = 10ULL ; out . mJc [ 0 ] = 0 ;
...
10ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 1 ; out . mJc [ 2 ] = 6 ; out
. mJc [ 3 ] = 6 ; out . mJc [ 4 ] = 7 ; out . mJc [ 5 ] = 7 ; out . mJc [ 6 ]
= 8 ; out . mJc [ 7 ] = 11 ; out . mJc [ 8 ] = 14 ; out . mJc [ 9 ] = 16 ;
out . mJc [ 10 ] = 18 ; out . mIr [ 0 ] = 0 ; out . mIr [ 1 ] = 1 ; out . mIr
[ 2 ] = 3 ; out . mIr [ 3 ] = 4 ; out . mIr [ 4 ] = 7 ; out . mIr [ 5 ] = 9 ;
out . mIr [ 6 ] = 9 ; out . mIr [ 7 ] = 5 ; out . mIr [ 8 ] = 4 ; out . mIr [
9 ] = 6 ; out . mIr [ 10 ] = 9 ; out . mIr [ 11 ] = 3 ; out . mIr [ 12 ] = 6
; out . mIr [ 13 ] = 9 ; out . mIr [ 14 ] = 4 ; out . mIr [ 15 ] = 7 ; out .
mIr [ 16 ] = 2 ; out . mIr [ 17 ] = 8 ; ( void ) sys ; ( void ) t2 ; return 0
...
= 2ULL ; out . mNumRow = 10ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ;
...
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mC_P ; out . mNumCol = 1ULL ; out . mNumRow = 10ULL
...
. mIr [ 0 ] = 5 ; out . mIr [ 1 ] = 6 ; ( void ) sys ; ( void ) t2 ; return 0
; } static int32_T ds_tdxf_p ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mTDXF_P ; out . mNumCol = 10ULL ; out . mNumRow =
10ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 1 ; out . mJc [ 2 ] = 6 ; out
. mJc [ 3 ] = 6 ; out . mJc [ 4 ] = 7 ; out . mJc [ 5 ] = 10 ; out . mJc [ 6
] = 12 ; out . mJc [ 7 ] = 17 ; out . mJc [ 8 ] = 20 ; out . mJc [ 9 ] = 22 ;
out . mJc [ 10 ] = 24 ; out . mIr [ 0 ] = 0 ; out . mIr [ 1 ] = 1 ; out . mIr
[ 2 ] = 3 ; out . mIr [ 3 ] = 4 ; out . mIr [ 4 ] = 7 ; out . mIr [ 5 ] = 9 ;
out . mIr [ 6 ] = 9 ; out . mIr [ 7 ] = 3 ; out . mIr [ 8 ] = 8 ; out . mIr [
9 ] = 9 ; out . mIr [ 10 ] = 5 ; out . mIr [ 11 ] = 6 ; out . mIr [ 12 ] = 3
; out . mIr [ 13 ] = 4 ; out . mIr [ 14 ] = 6 ; out . mIr [ 15 ] = 8 ; out .
mIr [ 16 ] = 9 ; out . mIr [ 17 ] = 3 ; out . mIr [ 18 ] = 6 ; out . mIr [ 19
] = 9 ; out . mIr [ 20 ] = 4 ; out . mIr [ 21 ] = 7 ; out . mIr [ 22 ] = 2 ;
out . mIr [ 23 ] = 8 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static
...
out . mX [ 1 ] = false ; out . mX [ 2 ] = false ; out . mX [ 3 ] = true ; out
. mX [ 4 ] = false ; out . mX [ 5 ] = true ; out . mX [ 6 ] = true ; out . mX
[ 7 ] = true ; out . mX [ 8 ] = true ; out . mX [ 9 ] = true ; ( void ) sys ;
( void ) t2 ; return 0 ; } static int32_T ds_slf ( const NeDynamicSystem *
sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) {
PmBoolVector out ; ( void ) t1 ; out = t2 -> mSLF ; out . mX [ 0 ] = false ;
...
void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_dnf ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { PmRealVector out ; ( void ) t1 ; out = t2 -> mDNF ; out . mX [ 0 ] = -
1.0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_dnf_p (
const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mDNF_P ; out . mNumCol = 6ULL ; out . mNumRow = 10ULL ; out . mJc [ 0 ] = 0 ;
out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 1 ; out . mJc [ 3 ] = 1 ; out . mJc [
4 ] = 1 ; out . mJc [ 5 ] = 1 ; out . mJc [ 6 ] = 1 ; out . mIr [ 0 ] = 5 ; (
...
true ; out . mX [ 4 ] = true ; out . mX [ 5 ] = false ; out . mX [ 6 ] = true
; out . mX [ 7 ] = true ; out . mX [ 8 ] = true ; out . mX [ 9 ] = true ; (
...
int32_T ds_vsf ( const NeDynamicSystem * sys , const NeDynamicSystemInput *
t1 , NeDsMethodOutput * t2 ) { PmBoolVector out ; ( void ) t1 ; out = t2 ->
mVSF ; out . mX [ 0 ] = false ; out . mX [ 1 ] = false ; out . mX [ 2 ] =
false ; out . mX [ 3 ] = false ; out . mX [ 4 ] = false ; out . mX [ 5 ] =
false ; out . mX [ 6 ] = false ; out . mX [ 7 ] = false ; out . mX [ 8 ] =
false ; out . mX [ 9 ] = false ; ( void ) sys ; ( void ) t2 ; return 0 ; }
...
mX [ 5 ] = 0.0 ; out . mX [ 6 ] = 1.0 ; out . mX [ 7 ] = 0.0 ; out . mX [ 8 ]
= 0.0 ; out . mX [ 9 ] = 0.0 ; ( void ) sys ; ( void ) t2 ; return 0 ; }
...
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mDXICR_P ; out . mNumCol = 10ULL ; out . mNumRow =
...
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mDDICR_P ; out . mNumCol = 0ULL ; out . mNumRow =
1ULL ; out . mJc [ 0 ] = 0 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static
int32_T ds_tduicr_p ( const NeDynamicSystem * sys , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mTDUICR_P ; out . mNumCol = 2ULL ; out . mNumRow =
...
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mICRM_P ; out . mNumCol = 10ULL ; out . mNumRow = 1ULL ; out . mJc [ 0 ] = 0
...
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mDXICRM_P ; out . mNumCol = 10ULL ; out . mNumRow = 0ULL ; out . mJc [ 0 ] =
...
) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_ddicrm ( const
NeDynamicSystem * sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput *
t2 ) { ( void ) t1 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T
...
. mX [ 1 ] = 0.00050599999999999994 ; out . mX [ 2 ] = 1.0 ; out . mX [ 3 ] =
- 0.000109 ; out . mX [ 4 ] = 0.1 ; ( void ) sys ; ( void ) t2 ; return 0 ; }
...
= 5 ; out . mJc [ 7 ] = 5 ; out . mJc [ 8 ] = 5 ; out . mJc [ 9 ] = 5 ; out .
mJc [ 10 ] = 5 ; out . mIr [ 0 ] = 0 ; out . mIr [ 1 ] = 4 ; out . mIr [ 2 ]
= 1 ; out . mIr [ 3 ] = 3 ; out . mIr [ 4 ] = 2 ; ( void ) sys ; ( void ) t2
...
mNumCol = 10ULL ; out . mNumRow = 5ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1
] = 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out . mJc [ 4 ] = 0 ; out
. mJc [ 5 ] = 0 ; out . mJc [ 6 ] = 0 ; out . mJc [ 7 ] = 0 ; out . mJc [ 8 ]
= 0 ; out . mJc [ 9 ] = 0 ; out . mJc [ 10 ] = 0 ; ( void ) sys ; ( void ) t2
...
int32_T ds_mode ( const NeDynamicSystem * sys , const NeDynamicSystemInput *
t1 , NeDsMethodOutput * t2 ) { PmIntVector out ; real_T U_idx_1 ; real_T
X_idx_5 ; U_idx_1 = t1 -> mU . mX [ 1 ] ; X_idx_5 = t1 -> mX . mX [ 5 ] ; out
= t2 -> mMODE ; out . mX [ 0 ] = ( int32_T ) ( X_idx_5 < 0.0 ) ; out . mX [ 1
] = ( int32_T ) ( X_idx_5 <= 18.0 ) ; out . mX [ 2 ] = ( int32_T ) ( U_idx_1
> 2.5 ) ; ( void ) sys ; ( void ) t2 ; return 0 ; } static int32_T ds_dp_l (
const NeDynamicSystem * sys , const NeDynamicSystemInput * t1 ,
NeDsMethodOutput * t2 ) { ( void ) t1 ; ( void ) sys ; ( void ) t2 ; return 0
...
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mQX_P ; out . mNumCol = 10ULL ; out . mNumRow =
...
NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out = t2 ->
mQU_P ; out . mNumCol = 2ULL ; out . mNumRow = 10ULL ; out . mJc [ 0 ] = 0 ;
...
10ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ; ( void ) sys ; ( void )
...
; real_T X_idx_1 ; real_T X_idx_2 ; real_T X_idx_4 ; real_T X_idx_6 ; real_T
X_idx_7 ; real_T X_idx_8 ; X_idx_1 = t3 -> mX . mX [ 1 ] ; X_idx_2 = t3 -> mX
. mX [ 2 ] ; X_idx_4 = t3 -> mX . mX [ 4 ] ; X_idx_6 = t3 -> mX . mX [ 6 ] ;
X_idx_7 = t3 -> mX . mX [ 7 ] ; X_idx_8 = t3 -> mX . mX [ 8 ] ; out = t4 ->
mY ; out . mX [ 0 ] = - X_idx_6 ; out . mX [ 1 ] = X_idx_2 ; out . mX [ 2 ] =
X_idx_1 ; out . mX [ 3 ] = X_idx_8 ; out . mX [ 4 ] = X_idx_4 ; out . mX [ 5
] = X_idx_7 ; ( void ) sys ; ( void ) t4 ; return 0 ; } static int32_T ds_dxy
...
[ 3 ] = - 1.0 ; out . mX [ 4 ] = 1.0 ; out . mX [ 5 ] = 1.0 ; ( void ) sys ;
( void ) t3 ; return 0 ; } static int32_T ds_dxy_p ( const NeDynamicSystem *
sys , const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) {
PmSparsityPattern out ; ( void ) t1 ; out = t2 -> mDXY_P ; out . mNumCol =
10ULL ; out . mNumRow = 6ULL ; out . mJc [ 0 ] = 0 ; out . mJc [ 1 ] = 0 ;
out . mJc [ 2 ] = 1 ; out . mJc [ 3 ] = 2 ; out . mJc [ 4 ] = 2 ; out . mJc [
5 ] = 3 ; out . mJc [ 6 ] = 3 ; out . mJc [ 7 ] = 4 ; out . mJc [ 8 ] = 5 ;
out . mJc [ 9 ] = 6 ; out . mJc [ 10 ] = 6 ; out . mIr [ 0 ] = 2 ; out . mIr
[ 1 ] = 1 ; out . mIr [ 2 ] = 4 ; out . mIr [ 3 ] = 0 ; out . mIr [ 4 ] = 5 ;
out . mIr [ 5 ] = 3 ; ( void ) sys ; ( void ) t2 ; return 0 ; } static
...
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ;
( void ) t1 ; out = t2 -> mDUY_P ; out . mNumCol = 2ULL ; out . mNumRow =
...
t2 -> mMDXY_P ; out . mNumCol = 10ULL ; out . mNumRow = 6ULL ; out . mJc [ 0
] = 0 ; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 0 ; out . mJc [ 3 ] = 0 ; out
. mJc [ 4 ] = 0 ; out . mJc [ 5 ] = 0 ; out . mJc [ 6 ] = 0 ; out . mJc [ 7 ]
= 0 ; out . mJc [ 8 ] = 0 ; out . mJc [ 9 ] = 0 ; out . mJc [ 10 ] = 0 ; (
...
* t1 , NeDsMethodOutput * t2 ) { PmSparsityPattern out ; ( void ) t1 ; out =
t2 -> mTDXY_P ; out . mNumCol = 10ULL ; out . mNumRow = 6ULL ; out . mJc [ 0
] = 0 ; out . mJc [ 1 ] = 0 ; out . mJc [ 2 ] = 1 ; out . mJc [ 3 ] = 2 ; out
. mJc [ 4 ] = 2 ; out . mJc [ 5 ] = 3 ; out . mJc [ 6 ] = 3 ; out . mJc [ 7 ]
= 4 ; out . mJc [ 8 ] = 5 ; out . mJc [ 9 ] = 6 ; out . mJc [ 10 ] = 6 ; out
. mIr [ 0 ] = 2 ; out . mIr [ 1 ] = 1 ; out . mIr [ 2 ] = 4 ; out . mIr [ 3 ]
= 0 ; out . mIr [ 4 ] = 5 ; out . mIr [ 5 ] = 3 ; ( void ) sys ; ( void ) t2
...
t4 ) { PmRealVector out ; real_T U_idx_1 ; real_T X_idx_5 ; real_T t1 ;
int32_T M_idx_0 ; M_idx_0 = t3 -> mM . mX [ 0 ] ; U_idx_1 = t3 -> mU . mX [ 1
] ; X_idx_5 = t3 -> mX . mX [ 5 ] ; out = t4 -> mZC ; if ( M_idx_0 == 0 ) {
U_idx_1 -= 2.5 ; } else { U_idx_1 = 0.0 ; } if ( M_idx_0 == 0 ) { t1 = 18.0 -
X_idx_5 ; } else { t1 = 0.0 ; } out . mX [ 0 ] = U_idx_1 ; out . mX [ 1 ] = -
X_idx_5 ; out . mX [ 2 ] = t1 ; ( void ) sys ; ( void ) t4 ; return 0 ; }
