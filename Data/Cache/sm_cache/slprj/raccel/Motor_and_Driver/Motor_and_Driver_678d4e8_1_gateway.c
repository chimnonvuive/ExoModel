...
void Motor_and_Driver_678d4e8_1_gateway ( void ) { NeModelParameters
modelparams = { ( NeSolverType ) 2 , 0.001 , 0 , 0 , 0.001 , 0 , 0 , 0 , 0 ,
( SscLoggingSetting ) 0 , 571841566 , 0 , } ; NeSolverParameters solverparams
= { 0 , 0 , 1 , 0 , 0 , 0.001 , 1e-06 , 1e-09 , 0 , 0 , 100 , 0 , 1 , 0 ,
1e-09 , 1 , ( NeLocalSolverChoice ) 1 , 6e-05 , 1 , 3 , 2 , 0 , 2 , (
...
Motor_and_Driver_678d4e8_1_dae ( & dae , & modelparams , & solverparams ) ;
nesl_register_simulator_group ( "Motor_and_Driver/Solver Configuration_1" , 1
