...
int32_T Motor_and_Driver_678d4e8_1_ds_obs_il ( const NeDynamicSystem * sys ,
const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { static boolean_T
_cg_const_1 [ 133 ] = { true , true , true , false , true , true , true ,
...
, true , true , true , true , true , true , true , true , true , true , true
, true , true , true , true , true , true , true , true , true , true , true
, true , true , true , true , true , true } ; PmBoolVector out ; int32_T b ;
boolean_T t0 [ 133 ] ; ( void ) t1 ; out = t2 -> mOBS_IL ; for ( b = 0 ; b <
133 ; b ++ ) { t0 [ b ] = _cg_const_1 [ b ] ; } for ( b = 0 ; b < 133 ; b ++
