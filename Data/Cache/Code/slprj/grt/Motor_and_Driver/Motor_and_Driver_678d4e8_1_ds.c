...
static NeEquationData s_equation_data[16] = { { "", 0U, 8,
    ...
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 5U, 0U,
    ...
    1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Motor_and_Driver/Motor/Foster Thermal Model", 3U, 14U, TRUE, 1.0, "1", }, {
    "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Motor_and_Driver/Motor/Foster Thermal Model", 3U, 17U, TRUE, 1.0, "1", }, {
    "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Motor_and_Driver/Driver/Current controller/Drive Plant/Controlled PWM Voltage",
    1U, 20U, FALSE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 9U, 21U,
    TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Motor_and_Driver/Load/Digital incremental encoder/Ideal Rotational Motion Sensor",
    1U, 30U, TRUE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Motor_and_Driver/Load/Harmonic Drive", 1U, 31U, TRUE, 1.0, "1", }, { "", 0U,
    8, NE_EQUATION_DOMAIN_TIME, "Motor_and_Driver/Load/Rotational Friction", 1U,
    32U, FALSE, 1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Motor_and_Driver/Motor/DC Motor", 1U, 33U, TRUE, 1.0, "1", }, { "", 0U, 8,
    NE_EQUATION_DOMAIN_TIME, "Motor_and_Driver/Motor/DC Motor", 1U, 34U, FALSE,
    1.0, "1", }, { "", 0U, 8, NE_EQUATION_DOMAIN_TIME,
    "Motor_and_Driver/Motor/DC Motor", 1U, 35U, FALSE, 1.0, "1", } };

static NeCERData *s_cer_data = NULL;
static NeICRData s_icr_data[3] = { { "", 0U, 1,
    "Motor_and_Driver/Motor/Foster Thermal Model", 2U, 0U, }, { "", 1U, 1,
    "Motor_and_Driver/Motor/Foster Thermal Model", 2U, 0U, }, { "", 0U, 0,
    "Motor_and_Driver/Load/Harmonic Drive", 1U, 2U, } };

static NeVariableData s_variable_data[16] = { {
    "Driver.Current_controller.Drive_Plant.H_Bridge.v_lag", 0U, 0,
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1.0, "1",
    ...
    "Motor.Foster_Thermal_Model.Tdrop", 0U, 0,
    "Motor_and_Driver/Motor/Foster Thermal Model", 1.0, "1", 0.0, TRUE, FALSE,
    1U, 2U, NE_INIT_MODE_NONE, "Tdrop", }, { "Motor.Foster_Thermal_Model.Tdrop",
    1U, 0, "Motor_and_Driver/Motor/Foster Thermal Model", 1.0, "1", 0.0, TRUE,
    FALSE, 1U, 2U, NE_INIT_MODE_NONE, "Tdrop", }, {
    "Driver.Current_controller.Drive_Plant.Controlled_PWM_Voltage.p2.v", 0U, 1,
    "Motor_and_Driver/Driver/Current controller/Drive Plant/Controlled PWM Voltage",
    1.0, "1", 0.0, FALSE, FALSE, 1U, 1U, NE_INIT_MODE_NONE, "Voltage", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.i2", 0U, 0,
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1.0, "1",
...
static NeObservableData s_observable_data[146] = { {
    "Driver.Current_controller.Drive_Plant.Controlled_PWM_Voltage.i1",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/Controlled PWM Voltage",
    1U, 1U, "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Input current", }, {
    "Driver.Current_controller.Drive_Plant.Controlled_PWM_Voltage.n1.v",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/Controlled PWM Voltage",
    1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Driver.Current_controller.Drive_Plant.Controlled_PWM_Voltage.n2.v",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/Controlled PWM Voltage",
    1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Driver.Current_controller.Drive_Plant.Controlled_PWM_Voltage.p1.v",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/Controlled PWM Voltage",
    1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Driver.Current_controller.Drive_Plant.Controlled_PWM_Voltage.p2.v",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/Controlled PWM Voltage",
    1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Driver.Current_controller.Drive_Plant.Controlled_PWM_Voltage.pwm.duty_cycle",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/Controlled PWM Voltage",
    1U, 1U, "1", 1.0, "1", NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Duty cycle", }, {
    "Driver.Current_controller.Drive_Plant.Controlled_PWM_Voltage.pwm.i2",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/Controlled PWM Voltage",
    1U, 1U, "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Output current", }, {
    "Driver.Current_controller.Drive_Plant.Controlled_PWM_Voltage.pwm.n2.v",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/Controlled PWM Voltage",
    1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Driver.Current_controller.Drive_Plant.Controlled_PWM_Voltage.pwm.p2.v",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/Controlled PWM Voltage",
    1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Driver.Current_controller.Drive_Plant.Controlled_PWM_Voltage.pwm.v2",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/Controlled PWM Voltage",
    1U, 1U, "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE,
    FALSE, NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Output voltage", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.BRK.v",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.ENA.v",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.REF.v",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.REV.v",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.i2",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 1U,
    "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current (+ -> -)", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.iBRK",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 1U,
    "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current (BRK -> REF)", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.iENA",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 1U,
    "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current (ENA -> REF)", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.iREV",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 1U,
    "A", 1.0, "A", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Current (REV -> REF)", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.n1.v",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Voltage", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.n2.v",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.p1.v",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE, "Voltage", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.p2.v",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.power_dissipated",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 1U,
    "W", 1.0, "kW", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Power dissipated", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.v2",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 1U,
    "V", 1.0, "V", NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Output voltage", }, {
    "Driver.Current_controller.Drive_Plant.H_Bridge.v_lag",
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 1U,
  ...
  { "Driver.Current_controller.Drive_Plant.I_to_U.x.v",
    ...
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Voltage", }, {
    "Motor.Foster_Thermal_Model.A.T",
    "Motor_and_Driver/Motor/Foster Thermal Model", 1U, 1U, "K", 1.0, "K",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Temperature", }, {
    "Motor.Foster_Thermal_Model.B.T",
    "Motor_and_Driver/Motor/Foster Thermal Model", 1U, 1U, "K", 1.0, "K",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Temperature", }, {
    "Motor.Foster_Thermal_Model.Q",
    "Motor_and_Driver/Motor/Foster Thermal Model", 1U, 1U, "W", 1.0, "kW",
    NE_NOMINAL_SOURCE_MODEL, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Heat flow rate", }, {
    "Motor.Foster_Thermal_Model.Tdrop",
    "Motor_and_Driver/Motor/Foster Thermal Model", 1U, 2U, "K", 1.0, "K",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, TRUE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Tdrop", }, {
    "Motor.Foster_Thermal_Model.Tvec",
    "Motor_and_Driver/Motor/Foster Thermal Model", 1U, 4U, "K", 1.0, "K",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, TRUE, FALSE,
    NE_FREQTIME_TYPE_TIME, FALSE, TRUE,
    "Vector of node temperatures [T1 ... Tn]", }, {
    "Motor.Foster_Thermal_Model.Tvec_private",
    "Motor_and_Driver/Motor/Foster Thermal Model", 1U, 2U, "K", 1.0, "K",
    NE_NOMINAL_SOURCE_DERIVED, NE_INIT_MODE_NONE, FALSE, FALSE,
    NE_FREQTIME_TYPE_TIME, TRUE, TRUE, "Tvec_private", }, { "Motor.M0.w",
...
static NeZCData s_zc_data[4] = { {
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 0U,
    "Driver.Current_controller.Drive_Plant.H_Bridge",
    ...
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp",
    NE_ZC_TYPE_FALSE, }, {
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 2U,
    "Driver.Current_controller.Drive_Plant.H_Bridge",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp",
    NE_ZC_TYPE_TRUE, }, { "Motor_and_Driver/Motor/Foster Thermal Model", 1U, 3U,
    "Motor.Foster_Thermal_Model",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/elec/library/m/+ee/+passive/+thermal/foster_model.sscp",
    NE_ZC_TYPE_TRUE, } };
...
static NeAssertData s_assert_data[13] = { {
    "Motor_and_Driver/Motor/Foster Thermal Model", 1U, 0U,
    "Motor.Foster_Thermal_Model",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/elec/library/m/+ee/+passive/+thermal/foster_model.sscp",
    FALSE,
    "Elements of Vector of node temperatures [T1 ... Tn] must be greater than or equal to 0 K.",
    ...
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Motor_and_Driver/Load/Harmonic Drive", 1U, 6U,
    "Load.Harmonic_Drive.gear.damperF.power_dissipated",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+rotational/damper.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", }, {
    "Motor_and_Driver/Driver/Current controller/Drive Plant/Controlled PWM Voltage",
    1U, 7U, "Driver.Current_controller.Drive_Plant.Controlled_PWM_Voltage",
    ...
    "Motor_and_Driver/Driver/Current controller/Drive Plant/H-Bridge", 1U, 8U,
    "Driver.Current_controller.Drive_Plant.H_Bridge",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp",
    FALSE, "In divide, the denominator must be nonzero.",
    "physmod:common:mf:expr:analyze:RequireDenominatorNonzero", }, {
    ...
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Motor_and_Driver/Load/Rotational Friction", 1U, 10U,
    "Load.Rotational_Friction",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/simscape/library/m/+foundation/+mechanical/+rotational/friction.ssc",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    ...
    "In power, the exponent must be positive when the base is equal to zero.",
    "physmod:common:mf:expr:analyze:RequireExponentPositive", }, {
    "Motor_and_Driver/Motor/DC Motor", 1U, 12U, "Motor.DC_Motor",
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/elec/library/m/+ee/+electromech/+brushed/dc_motor_thermal.sscp",
    FALSE,
    "In power, the base must be nonnegative when the exponent is not an integer.",
    "physmod:common:mf:expr:analyze:RequireBaseNonnegative", } };

static NeRange s_assert_range[13] = { {
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/elec/library/m/+ee/+passive/+thermal/foster_model.sscp",
    1U, 1U, 1U, 1U, NE_RANGE_TYPE_PROTECTED, }, {
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp",
    1U, 1U, 1U, 1U, NE_RANGE_TYPE_PROTECTED, }, {
...
static NeRange s_equation_range[36] = { {
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp",
    1U, 1U, 1U, 1U, NE_RANGE_TYPE_PROTECTED, }, {
    "C:/Program Files/MATLAB/R2021b/toolbox/physmod/elec/library/m/+ee/+semiconductors/+converters/h_bridge.sscp",
    1U, 1U, 1U, 1U, NE_RANGE_TYPE_PROTECTED, }, {
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mICR.mN = 3;
  out->mICR.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 3);
  return out;
}
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mICRM.mN = 4;
  out->mICRM.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 4);
  return out;
}
  ...
  *allocator)
{
  ...
  out = (NeDsMethodOutput *) allocator->mCallocFcn(allocator, sizeof
    (NeDsMethodOutput), 1);
  out->mLOG.mN = 89;
  out->mLOG.mX = (real_T *) allocator->mCallocFcn(allocator, sizeof(real_T), 89);
  return out;
}
...
NeDynamicSystem *Motor_and_Driver_678d4e8_1_dae_ds(PmAllocator *allocator)
{
  ...
  ds->mNumICResiduals = 3;
  ds->mNumModes = 4;
  ds->mNumMajorModes = 0;
  ds->mNumRealCache = 0;
  ds->mNumIntCache = 0;
  ds->mNumObservables = 146;
  ds->mNumObservableElements = 148;
  ds->mNumZcs = 4;
  ds->mNumAsserts = 13;
  ds->mNumAssertRanges = 13;
  ds->mNumParamAsserts = 0;
  ds->mNumParamAssertRanges = 0;
  ds->mNumInitialAsserts = 0;
  ds->mNumInitialAssertRanges = 0;
  ds->mNumRanges = 4;
  ds->mNumEquationRanges = 36;
  ds->mNumCERRanges = 0;
  ds->mNumICRRanges = 3;
                     ...
                     NeDsMethodOutput *t2)
{
  ...
  out.mX[2] = -0.01;
  out.mX[3] = -0.000109;
  out.mX[4] = 0.0018099258772859873;
  ...
  *t7, NeDsMethodOutput *t8)
{
  ...
  out.mX[1] = (int32_T)(X_idx_8 <= 18.0);
  out.mX[2] = (int32_T)(U_idx_1 > 2.5);
  out.mX[3] = (int32_T)((X_idx_4 >= 0.0) && (-X_idx_6 + X_idx_4 >= 0.0));
  (void)sys;
  (void)t8;
  return 0;
}
                     ...
                     NeDsMethodOutput *t4)
{
  ...
  out.mX[2] = X_idx_11;
  out.mX[3] = X_idx_14;
  out.mX[4] = (-X_idx_6 + -X_idx_7) + X_idx_4;
  out.mX[5] = X_idx_10;
  (void)sys;
  (void)t4;
  return 0;
...
static int32_T ds_zc (const NeDynamicSystem *sys, const NeDynamicSystemInput
                      *t11, NeDsMethodOutput *t12)
{
  PmRealVector out;
  real_T U_idx_1;
  real_T X_idx_4;
  ...
  out.mX[1] = -X_idx_8;
  out.mX[2] = U_idx_1;
  out.mX[3] = X_idx_4 > t10 ? t10 : X_idx_4;
  (void)sys;
  (void)t12;
  return 0;
}
