...
#define rtmGetClockTick4(rtm)          ( *(((rtm)->timingBridge->clockTick[(rtm)->Timing.mdlref_GlobalTID[4]])) )
#endif
...
#define rtmGetClockTickH4(rtm)         ( *((rtm)->timingBridge->clockTickH[(rtm)->Timing.mdlref_GlobalTID[4]]) )
#endif
