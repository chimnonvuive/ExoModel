...
int32_T Motor_and_Driver_678d4e8_1_ds_obs_all(const NeDynamicSystem *sys, const
  NeDynamicSystemInput *t4, NeDsMethodOutput *t5)
{
  ...
  Load_Harmonic_Drive_gear_tB = X_idx_11 * -0.01 + X_idx_12 * -0.01;
  t0[0ULL] = 0.0;
  t0[1ULL] = 0.0;
  t0[2ULL] = 0.0;
  t0[3ULL] = U_idx_0;
  t0[4ULL] = X_idx_6;
  t0[5ULL] = Driver_Current_controller_Drive_Plant_Controlled_PWM_Voltage1_1;
  t0[6ULL] = 0.0;
  t0[7ULL] = 0.0;
  t0[8ULL] = X_idx_6;
  t0[9ULL] = Driver_Current_controller_Drive_Plant_Controlled_PWM_Voltage1_1 *
    18.0;
  t0[10ULL] = 0.0;
  t0[11ULL] = X_idx_6;
  t0[12ULL] = 0.0;
  ...
  t0[20ULL] = 0.0;
  t0[21ULL] = X_idx_8;
  t0[22ULL] = X_idx_7 * X_idx_7 * 0.0001 * 1000.0;
  t0[23ULL] = X_idx_8;
  t0[24ULL] = X_idx_0;
  t0[25ULL] = 0.0;
  t0[26ULL] = 0.0;
  ...
  t0[111ULL] = 0.0;
  t0[112ULL] = X_idx_8;
  t0[113ULL] = X_idx_13 * 1000.0;
  t0[114ULL] = X_idx_11 * 0.01 + X_idx_12 * 0.01;
  t0[115ULL] = X_idx_4;
  t0[116ULL] = X_idx_8;
  t0[117ULL] = 0.0;
  t0[118ULL] = X_idx_5 * 9.5492965855137211;
  t0[119ULL] = 0.0;
  t0[120ULL] = X_idx_2 * -100.0;
  t0[121ULL] = 0.0;
  t0[122ULL] = 0.0;
  t0[123ULL] = X_idx_4;
  t0[124ULL] = X_idx_4;
