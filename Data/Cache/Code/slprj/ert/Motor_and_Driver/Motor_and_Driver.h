...
/* Block signals and states (default storage) for model 'Motor_and_Driver' */
typedef struct {
...
typedef struct {
  DW_Motor_and_Driver_fwu4_T rtdw;
  RT_MODEL_Motor_and_Driver_T rtm;
} MdlrefDW_Motor_and_Driver_T;
...
extern void Motor_and_Driver_initialize(const rtTimingBridge *timingBridge,
...
extern void Motor_and_Driver_Init(DW_Motor_and_Driver_fwu4_T *localDW);
extern void Motor_and_Driver(RT_MODEL_Motor_and_Driver_T * const
  Motor_and_Driver_M, const real32_T *rtu_RefSignal, real32_T
