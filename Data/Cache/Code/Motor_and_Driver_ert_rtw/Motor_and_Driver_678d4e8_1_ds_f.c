  ...
  NeDynamicSystemInput *t4, NeDsMethodOutput *t5)
{
  ...
  if (M_idx_0 != 0) {
    X_idx_6 = X_idx_8 - X_idx_7 * 0.1;
  } else if (M_idx_1 != 0) {
    X_idx_6 = X_idx_8 - (X_idx_7 * 0.1 + X_idx_6 * U_idx_0 * 18.0 / 18.0);
  } else {
    X_idx_6 = X_idx_8 - (U_idx_0 * 18.0 + X_idx_7 * 0.1);
  }
  ...
  out.mX[2] = -0.0;
  out.mX[3] = 0.0;
  out.mX[4] = ((X_idx_4 - 298.15) * 0.00393 + 1.0) * X_idx_7 *
    -0.10939185165546103;
  out.mX[5] = -0.0;
  out.mX[6] = -intrm_sf_mf_1;
  out.mX[7] = X_idx_6;
  out.mX[8] = 0.0;
  out.mX[9] = 0.0;
  out.mX[10] = U_idx_0;
  out.mX[11] = 0.0;
  out.mX[12] = -(((X_idx_4 - 298.15) * 0.00393 + 1.0) * X_idx_7 * X_idx_7 *
                 0.00010939185165546103);
  out.mX[13] = -(-(((X_idx_4 - 298.15) * 0.00393 + 1.0) * X_idx_7 *
