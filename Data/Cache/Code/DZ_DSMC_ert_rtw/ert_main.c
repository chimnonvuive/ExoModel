...
void rt_OneStep(void)
{
  ...
  currentTime = (extmodeSimulationTime_T) DZ_DSMC_M->Timing.clockTick0;
  DZ_DSMC_step();
...
int main(void)
{
  ...
  errorCode = extmodeInit(DZ_DSMC_M->extModeInfo, &rtmGetTFinal(DZ_DSMC_M));
  if (errorCode != EXTMODE_SUCCESS) {
  ...
  if (errorCode == EXTMODE_SUCCESS) {
    ...
    if (extmodeStopRequested()) {
      rtmSetStopRequested(DZ_DSMC_M, true);
    }
  }
