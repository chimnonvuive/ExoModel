...
## 
## Makefile     : DZ_DSMC.mk
## Generated on : Fri Apr 15 17:33:57 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DZ_DSMC.exe
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DZ_DSMC.exe
...
DEFINES_STANDARD = -DMODEL=DZ_DSMC -DNUMST=5 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/DZ_DSMC_ert_rtw/DZ_DSMC.c $(START_DIR)/DZ_DSMC_ert_rtw/DZ_DSMC_data.c
...
OBJS = DZ_DSMC.obj DZ_DSMC_data.obj
...
%.obj : $(START_DIR)/DZ_DSMC_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/DZ_DSMC_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
DZ_DSMC.obj : $(START_DIR)/DZ_DSMC_ert_rtw/DZ_DSMC.c
	$(CC) $(CFLAGS) -o "$@" "$<"


DZ_DSMC_data.obj : $(START_DIR)/DZ_DSMC_ert_rtw/DZ_DSMC_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
